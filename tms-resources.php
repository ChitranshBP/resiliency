...
<main>
    ...
    <section class="relative h-[60vh] min-h-[500px] flex items-center justify-center overflow-hidden pt-24">
        ...
        <div class="absolute inset-0 z-0 bg-[#0B2035]">
            <img src="assets/images/hero_bg.png" alt="TMS Therapy Resources" class="w-full h-full object-cover">
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
            <div class="max-w-3xl reveal text-left">
                <div class="flex items-center gap-3 mb-6">
                    ...
                    <span class="text-[#23bfe2] text-sm font-bold tracking-widest uppercase">Patient Education</span>
                </div>
                <h1 class="text-4xl md:text-5xl lg:text-7xl font-bold text-white tracking-tight leading-tight mb-6">
                    TMS Therapy <br/><span class="text-[#23bfe2] font-light">Resources</span>
                </h1>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16 reveal">
                <h2 class="text-3xl md:text-4xl lg:text-5xl font-bold text-[#0B2035] mb-6">
                    TMS Therapy <span class="text-transparent bg-clip-text bg-gradient-to-r from-[#23bfe2] to-[#1da1bf]">Resources</span>
                </h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 reveal">
                ...
                <a href="tms-therapy.php" class="group bg-white border border-gray-100 rounded-[2rem] p-8 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                    ...
                    <h3 class="text-xl font-bold text-[#0B2035] mb-3">Understanding TMS</h3>
                ...
                <a href="accelerated-tms.php" class="group bg-white border border-gray-100 rounded-[2rem] p-8 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                    ...
                    <h3 class="text-xl font-bold text-[#0B2035] mb-3">Accelerated TMS</h3>
                ...
                <a href="tms-faq.php" class="group bg-white border border-gray-100 rounded-[2rem] p-8 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                    ...
                    <h3 class="text-xl font-bold text-[#0B2035] mb-3">TMS FAQ</h3>
                    <p class="text-gray-600 font-light leading-relaxed">Answers to the most common questions about TMS therapy.</p>
                    <div class="mt-6 flex items-center gap-2 text-[#23bfe2] font-bold text-sm group-hover:gap-3 transition-all">
                        Learn More <i data-lucide="arrow-right" class="w-4 h-4"></i>
                    </div>
                </a>
                ...
                <a href="insurance.php" class="group bg-white border border-gray-100 rounded-[2rem] p-8 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                    ...
                    <p class="text-gray-600 font-light leading-relaxed">Learn about insurance coverage for TMS therapy.</p>
                    <div class="mt-6 flex items-center gap-2 text-[#23bfe2] font-bold text-sm group-hover:gap-3 transition-all">
                        Learn More <i data-lucide="arrow-right" class="w-4 h-4"></i>
                    </div>
                </a>
                ...
                <a href="reviews.php" class="group bg-white border border-gray-100 rounded-[2rem] p-8 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                    ...
                    <p class="text-gray-600 font-light leading-relaxed">Read what our patients say about their TMS experience.</p>
                    <div class="mt-6 flex items-center gap-2 text-[#23bfe2] font-bold text-sm group-hover:gap-3 transition-all">
                        Learn More <i data-lucide="arrow-right" class="w-4 h-4"></i>
                    </div>
                </a>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center reveal">
                <div>
                    ...
                    <h2 class="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6 leading-tight">
                        Deep TMS vs. <span class="text-[#23bfe2] font-light">Traditional TMS</span>
                    </h2>
                    <p class="text-lg text-gray-300 font-light leading-relaxed mb-8">
                        Learn about the differences between Deep TMS and traditional TMS technology. Our BrainsWay Deep TMS system reaches broader and deeper brain regions for more effective treatment outcomes.
                    </p>
                ...
                <div class="relative">
                    <div class="rounded-[2rem] overflow-hidden shadow-2xl aspect-video">
                        <iframe class="w-full h-full" src="https://www.youtube.com/embed/p2xO4FdpAo0" title="Deep TMS vs. Traditional TMS" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="py-16 relative overflow-hidden bg-white">
        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10 reveal">
            ...
            <p class="text-xl text-gray-600 mb-12 font-light max-w-2xl mx-auto leading-relaxed">
                Book a free discovery call to learn how Deep TMS can help you on your journey to mental wellness.
            </p>
