...
<main>
    ...
    <section class="relative min-h-[500px] md:h-[60vh] flex items-center justify-center overflow-hidden pt-28 pb-12 md:pt-24 md:pb-0">
        <div class="absolute inset-0 z-0 bg-[#0B2035]">
            <img src="assets/images/depression_hero.png" alt="Depression Treatment Hope" class="w-full h-full object-cover object-[50%_30%]">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="bg-white/5 border border-white/10 rounded-[2rem] p-8 hover:-translate-y-2 transition-all duration-300 reveal reveal-delay-3 group flex flex-col items-center text-center">
                    ...
                    <p class="text-gray-300 font-light leading-relaxed">Nutritional counseling, supplement protocols, and lifestyle coaching.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="relative overflow-hidden bg-gradient-to-r from-[#0B2035] via-[#0e2841] to-[#0B2035]">
        <div class="absolute -top-20 -right-20 w-72 h-72 bg-[#23bfe2]/15 rounded-full blur-[100px] pointer-events-none"></div>
        <div class="absolute -bottom-20 -left-20 w-72 h-72 bg-[#23bfe2]/10 rounded-full blur-[100px] pointer-events-none"></div>
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-10 relative z-10">
            <div class="flex flex-col md:flex-row items-center justify-between gap-6 md:gap-10">
                <div class="flex items-center gap-4 md:gap-6 text-center md:text-left">
                    <div class="hidden sm:flex w-14 h-14 md:w-16 md:h-16 bg-[#23bfe2]/15 rounded-2xl items-center justify-center text-[#23bfe2] flex-shrink-0">
                        <i data-lucide="clipboard-check" class="w-7 h-7 md:w-8 md:h-8"></i>
                    </div>
                    <div>
                        <p class="text-[#23bfe2] text-xs font-bold tracking-widest uppercase mb-1">Free Self-Assessment</p>
                        <h3 class="text-xl md:text-2xl lg:text-3xl font-bold text-white leading-tight">Wondering if Deep TMS could help your depression?</h3>
                        <p class="text-gray-300 text-sm md:text-base font-light mt-1">Take our 3-minute candidacy quiz &mdash; confidential and physician-reviewed.</p>
                    </div>
                </div>
                <a href="tms-quiz.php" class="group inline-flex items-center justify-center gap-2 bg-[#23bfe2] hover:bg-white text-[#0B2035] font-bold px-6 md:px-8 py-3.5 rounded-full transition-all hover:-translate-y-1 shadow-lg whitespace-nowrap flex-shrink-0">
                    Take the Quiz
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="space-y-4">
                ...
                <div class="bg-white/5 border border-white/10 rounded-2xl overflow-hidden reveal">
                    ...
                    <div class="px-8 pb-8 text-gray-300 font-light leading-relaxed text-lg hidden faq-content">
                        <div class="pt-2 border-t border-white/10 mt-2">
                           A standard course involves daily sessions (5 days per week) over 6–8 weeks. Each session typically lasts around 10 minutes, depending on the protocol. Some patients may qualify for accelerated treatment options, but your provider will recommend the best plan based on your needs.
                        </div>
                    </div>
                </div>
