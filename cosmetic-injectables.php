...
<main>
    ...
    <section class="relative h-[60vh] min-h-[500px] flex items-center justify-center overflow-hidden pt-24">
        ...
        <div class="absolute inset-0 z-0 bg-[#0B2035]">
            <img src="assets/images/service_wellness.png" alt="Cosmetic Injectables" class="w-full h-full object-cover">
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
            <div class="max-w-3xl reveal text-left">
                <div class="flex items-center gap-3 mb-6">
                    ...
                    <span class="text-[#23bfe2] text-sm font-bold tracking-widest uppercase">Aesthetic Medicine</span>
                </div>
                <h1 class="text-4xl md:text-5xl lg:text-7xl font-bold text-white tracking-tight leading-tight mb-6">
                    Cosmetic<br/><span class="text-[#23bfe2] font-light">Injectables</span>
                </h1>
                <p class="text-lg md:text-xl text-gray-200 mb-10 leading-relaxed font-light max-w-2xl">
                    Expert dermal fillers, Botox, Jeuveau, Sculptra, and SKINVIVE treatments customized for natural-looking enhancements—free consultations at our Newport Beach medspa.
                </p>
                <div class="flex flex-col sm:flex-row gap-4">
                    <a href="contact.php" class="bg-[#23bfe2] text-[#0B2035] font-bold px-8 py-4 rounded-full text-center transition-all hover:bg-white hover:shadow-[0_10px_30px_rgba(35,191,226,0.3)] shadow-md hover:-translate-y-1 transform flex items-center justify-center gap-2">
                        Book a Free Consultation <i data-lucide="arrow-right" class="w-5 h-5"></i>
                    </a>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="flex flex-col lg:flex-row items-center gap-16 lg:gap-20">
                ...
                <div class="w-full lg:w-1/2 text-[#0B2035] reveal">
                    ...
                    <h3 class="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">Service Menu</h3>
                    <p class="text-gray-600 text-lg mb-8 leading-relaxed font-light">
                        We specialize in cosmetic injectables customized to produce natural enhancements throughout the face. Our providers combine medical expertise with aesthetic artistry for results that look refreshed, never overdone. All consultations are complimentary.
                    </p>
                    ...
                    <div class="bg-neutral p-6 rounded-2xl mb-8 border border-gray-100">
                        <ul class="space-y-4">
                            ...
                            <li class="flex items-center gap-4">
                                ...
                                <span class="text-[#0B2035] font-semibold text-base">Medical expertise meets aesthetic artistry</span>
                            </li>
                            <li class="flex items-center gap-4">
                                <div class="bg-[#23bfe2]/20 p-2 rounded-lg text-[#23bfe2]">
                                    <i data-lucide="check" class="w-5 h-5"></i>
                                </div>
                                <span class="text-[#0B2035] font-semibold text-base">All consultations are complimentary</span>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="w-full lg:w-1/2 relative reveal reveal-delay-1">
                    <div class="relative rounded-[2.5rem] overflow-hidden shadow-2xl border border-gray-100 ring-1 ring-[#0B2035]/5">
                        <img src="assets/images/service_wellness.png" alt="Cosmetic injectables at Resiliency" class="w-full h-[550px] object-cover">
    ...
    <section id="services" class="py-16 bg-[#0B2035] relative overflow-hidden text-white border-t border-white/10">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="text-center max-w-3xl mx-auto mb-20 reveal">
                <h2 class="text-sm font-bold tracking-widest text-[#23bfe2] uppercase mb-4">Treatment Options</h2>
                <h3 class="text-4xl md:text-5xl font-bold mb-6">Our Injectable Treatments</h3>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white/5 border border-white/10 rounded-[2rem] p-8 hover:bg-white/10 transition-all duration-300 reveal group text-center">
                    ...
                    <p class="text-gray-400 font-light text-sm leading-relaxed">Smooth forehead lines, crow's feet, and frown lines. Results in days, lasts 3-4 months.</p>
                </div>
                ...
                <div class="bg-white/5 border border-white/10 rounded-[2rem] p-8 hover:bg-white/10 transition-all duration-300 reveal reveal-delay-1 group text-center">
                    ...
                    <p class="text-gray-400 font-light text-sm leading-relaxed">Juvederm and Versa for lips, cheeks, jawline, tear troughs, and laugh lines.</p>
                </div>
                ...
                <div class="bg-white/5 border border-white/10 rounded-[2rem] p-8 hover:bg-white/10 transition-all duration-300 reveal reveal-delay-2 group text-center">
                    ...
                    <p class="text-gray-400 font-light text-sm leading-relaxed">Collagen stimulator that restores facial volume. Results last up to 2 years.</p>
                </div>
                ...
                <div class="bg-white/5 border border-white/10 rounded-[2rem] p-8 hover:bg-white/10 transition-all duration-300 reveal group text-center">
                    ...
                    <p class="text-gray-400 font-light text-sm leading-relaxed">Injectable hydration gel for improved skin quality and glow. Lasts up to 6 months.</p>
                </div>
                ...
                <div class="bg-white/5 border border-white/10 rounded-[2rem] p-8 hover:bg-white/10 transition-all duration-300 reveal reveal-delay-1 group text-center">
                    ...
                    <p class="text-gray-400 font-light text-sm leading-relaxed">Botox or Jeuveau for Cupid's bow enhancement.</p>
                </div>
                ...
                <div class="bg-white/5 border border-white/10 rounded-[2rem] p-8 hover:bg-white/10 transition-all duration-300 reveal reveal-delay-2 group text-center">
                    ...
                    <h4 class="text-lg font-bold text-white mb-2">Custom Treatments</h4>
                    <p class="text-gray-400 font-light text-sm leading-relaxed">Personalized combination treatments with fillers, Botox, or Jeuveau tailored to your goals.</p>
                </div>
            </div>
        </div>
    </section>

    <!-- Treatment Areas - White BG -->
    <section class="py-16 bg-white relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center max-w-3xl mx-auto mb-20 reveal">
                <h2 class="text-sm font-bold tracking-widest text-[#23bfe2] uppercase mb-4">Areas We Treat</h2>
                <h3 class="text-4xl md:text-5xl font-bold text-primary mb-6">Treatment Areas</h3>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="bg-neutral rounded-[2rem] p-10 shadow-soft border border-gray-100 hover:-translate-y-2 hover:shadow-2xl transition-all duration-300 reveal group">
                    ...
                    <h4 class="text-2xl font-bold text-primary mb-4">Upper Face</h4>
                    <p class="text-gray-500 font-light leading-relaxed">Forehead lines, crow's feet, and frown lines smoothed with precision neurotoxin injections.</p>
                </div>
                ...
                <div class="bg-neutral rounded-[2rem] p-10 shadow-soft border border-gray-100 hover:-translate-y-2 hover:shadow-2xl transition-all duration-300 reveal reveal-delay-1 group">
                    ...
                    <h4 class="text-2xl font-bold text-primary mb-4">Mid Face</h4>
                    <p class="text-gray-500 font-light leading-relaxed">Laugh lines, smoker's lines, and marionettes addressed with dermal fillers for a refreshed look.</p>
                </div>
                ...
                <div class="bg-neutral rounded-[2rem] p-10 shadow-soft border border-gray-100 hover:-translate-y-2 hover:shadow-2xl transition-all duration-300 reveal reveal-delay-2 group">
                    ...
                    <h4 class="text-2xl font-bold text-primary mb-4">Lower Face</h4>
                    <p class="text-gray-500 font-light leading-relaxed">Lips, chin, and jawline sculpting for balanced, natural-looking facial harmony.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="space-y-4">
                ...
                <div class="bg-white/5 border border-white/10 rounded-2xl overflow-hidden reveal">
                    ...
                    <div class="px-8 pb-8 text-gray-300 font-light leading-relaxed text-lg hidden faq-content">
                        <div class="pt-2 border-t border-white/10 mt-2">
                            Botox/Jeuveau 3-4 months, dermal fillers 6-18 months, Sculptra up to 2 years, SKINVIVE up to 6 months.
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white/5 border border-white/10 rounded-2xl overflow-hidden reveal">
                    ...
                    <div class="px-8 pb-8 text-gray-300 font-light leading-relaxed text-lg hidden faq-content">
                        <div class="pt-2 border-t border-white/10 mt-2">
                            Most treatments have minimal downtime—mild swelling or bruising for 1-2 days.
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white/5 border border-white/10 rounded-2xl overflow-hidden reveal">
                    ...
                    <div class="px-8 pb-8 text-gray-300 font-light leading-relaxed text-lg hidden faq-content">
                        <div class="pt-2 border-t border-white/10 mt-2">
                            Yes! All aesthetic consultations are complimentary.
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="py-16 relative overflow-hidden bg-white">
        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10 reveal">
            <h2 class="text-4xl md:text-5xl lg:text-6xl font-bold text-[#0B2035] mb-8 leading-tight">
                Ready to <span class="text-transparent bg-clip-text bg-gradient-to-r from-[#23bfe2] to-[#1da1bf]">Book a Free Consultation?</span>
            </h2>
            <p class="text-xl text-gray-600 mb-12 font-light max-w-2xl mx-auto leading-relaxed">
                Schedule your complimentary consultation and discover injectable treatments customized to enhance your natural beauty.
            </p>
