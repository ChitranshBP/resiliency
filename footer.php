            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-12 mb-20">
                ...
                <div class="lg:col-span-2">
                    <a href="/" class="block mb-2">
                        <img src="/assets/images/logo/resiliency-new-logo.png" alt="Resiliency Mind+Body Medicine®" width="400" height="291" class="h-24 w-auto object-contain brightness-0 invert">
                    </a>
