        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-12 mb-20">
                ...
                <div class="lg:col-span-2">
                    <a href="/" class="block mb-2">
                        <img src="/assets/images/logo/resiliency-new-logo.webp" alt="Resiliency Mind+Body Medicine®" width="256" height="186" class="h-24 w-auto object-contain brightness-0 invert">
                    </a>
                ...
                <div class="lg:col-span-2">
                    ...
                    <ul class="grid grid-cols-2 gap-x-6 gap-y-4 text-sm">
                        ...
                        <li><a href="weight-loss" class="hover:text-lightblue transition-colors">Weight Loss</a></li>
            ...
            <div class="flex flex-wrap items-center gap-6 justify-center mb-10 py-6 border-t border-b border-white/5">
                ...
                <a href="https://solsticetraining.org" target="_blank" rel="noopener noreferrer">
                    <img src="https://ladybug-impala-xln8.squarespace.com/s/Badge-Instructor.png" alt="Solstice Training Institute Certified Instructor Badge" style="max-width: 180px; width: 100%; height: auto;">
                </a>
