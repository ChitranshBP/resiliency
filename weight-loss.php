<?php
$page_title       = 'Medical Weight Loss in Newport Beach & San Juan Capistrano, CA | Resiliency Mind + Body Medicine®';
$page_description = 'Physician-supervised medical weight loss in Newport Beach & San Juan Capistrano, CA using FDA-approved GLP-1 medications (semaglutide, tirzepatide). Personalized programs with nutritional coaching.';
$page_keywords    = 'medical weight loss Newport Beach, medical weight loss San Juan Capistrano, semaglutide Orange County, tirzepatide San Juan Capistrano, GLP-1 weight loss California, weight loss doctor Newport Beach CA';
...
<script type="application/ld+json">
{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"What medications do you prescribe for medical weight loss?","acceptedAnswer":{"@type":"Answer","text":"We prescribe FDA-approved GLP-1 medications including semaglutide (Ozempic/Wegovy) and tirzepatide (Mounjaro/Zepbound) as part of a comprehensive physician-supervised program."}},{"@type":"Question","name":"How quickly will I see weight loss results?","acceptedAnswer":{"@type":"Answer","text":"Most patients begin losing weight within the first 4-8 weeks. Clinical trials show average weight loss of 15-20% of body weight over 12-18 months with GLP-1 medications."}},{"@type":"Question","name":"Are there side effects of GLP-1 weight loss medications?","acceptedAnswer":{"@type":"Answer","text":"Common side effects include nausea, constipation, and decreased appetite, especially early in treatment. These typically resolve as your body adjusts. Our team monitors and manages side effects."}},{"@type":"Question","name":"Is the medical weight loss program covered by insurance?","acceptedAnswer":{"@type":"Answer","text":"Coverage varies by plan. Some insurers cover GLP-1 medications for obesity or diabetes management. Our team checks your benefits and helps identify the most affordable options."}},{"@type":"Question","name":"Can I do virtual visits for medical weight loss?","acceptedAnswer":{"@type":"Answer","text":"Yes. Most weight loss follow-up appointments are available via telehealth. Initial evaluation may require an in-person visit at our Newport Beach or San Juan Capistrano clinic."}},{"@type":"Question","name":"Do I need to follow a specific diet with GLP-1 medications?","acceptedAnswer":{"@type":"Answer","text":"We provide nutritional coaching alongside medication. While GLP-1s reduce appetite significantly, adopting a balanced whole-food diet enhances results and supports long-term weight maintenance."}}]}
</script>
SCHEMA;
?>
...
<main>
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
            <div class="max-w-3xl reveal text-left">
                <div class="flex items-center gap-3 mb-4 sm:mb-6">
                    ...
                    <span class="text-[#23bfe2] text-xs sm:text-sm font-bold tracking-widest uppercase">Medically Supervised Programs</span>
                </div>
                ...
                <div class="flex flex-col sm:flex-row gap-3 sm:gap-4">
                    <a href="contact" class="bg-[#23bfe2] text-[#0B2035] font-bold px-8 py-4 rounded-full text-center transition-all hover:bg-white hover:shadow-[0_10px_30px_rgba(35,191,226,0.3)] shadow-md hover:-translate-y-1 transform flex items-center justify-center gap-2">
                        Start Your Journey <i data-lucide="arrow-right" class="w-5 h-5"></i>
                    </a>
            ...
            <div class="flex flex-col lg:flex-row items-center gap-16 lg:gap-20">
                ...
                <div class="w-full lg:w-1/2 text-[#0B2035] reveal">
                    <div class="flex items-center gap-3 mb-4">
                        <span class="h-[2px] w-12 bg-[#23bfe2]"></span>
                        <h2 class="text-sm font-bold tracking-widest text-[#23bfe2] uppercase">Understanding Our Program</h2>
                    </div>
                    <h3 class="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">Physician-Supervised Weight Management</h3>
                    <p class="text-gray-600 text-lg mb-8 leading-relaxed font-light">
                        Our medical weight loss program goes beyond diet and exercise. We utilize FDA-approved GLP-1 receptor agonist medications—semaglutide and tirzepatide—that work by mimicking hormones that regulate appetite, slow gastric emptying, and improve insulin sensitivity. Combined with personalized nutritional guidance, behavioral health support, and regular medical monitoring, our program delivers sustainable, medically-backed results.
                    </p>
                    ...
                    <div class="bg-neutral p-6 rounded-2xl mb-8 border border-gray-100">
                        <ul class="space-y-4">
                            <li class="flex items-center gap-4">
                                ...
                                <span class="text-[#0B2035] font-semibold text-base">FDA-approved GLP-1 medications</span>
                            </li>
                            <li class="flex items-center gap-4">
                                <div class="bg-[#23bfe2]/20 p-2 rounded-lg text-[#23bfe2]">
                                    <i data-lucide="check" class="w-5 h-5"></i>
                                </div>
                                <span class="text-[#0B2035] font-semibold text-base">Personalized nutrition and lifestyle plans</span>
                            </li>
                            <li class="flex items-center gap-4">
                                <div class="bg-[#23bfe2]/20 p-2 rounded-lg text-[#23bfe2]">
                                    <i data-lucide="check" class="w-5 h-5"></i>
                ...
                <div class="w-full lg:w-1/2 relative reveal reveal-delay-1">
                    ...
                    <div class="absolute -bottom-8 -left-8 bg-white p-6 rounded-3xl border border-gray-100 shadow-[0_20px_40px_-10px_rgba(11,32,53,0.15)] flex items-center gap-5 group hover:-translate-y-2 transition-transform duration-500">
                        ...
                        <div>
                            <p class="text-4xl font-bold text-[#0B2035] tracking-tight">20<span class="text-[#23bfe2]">%</span></p>
                            <p class="text-xs text-gray-500 font-bold uppercase tracking-widest mt-1">Avg. Weight Loss</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="relative reveal reveal-delay-3 group">
                    <div class="bg-neutral rounded-[2rem] p-8 border border-gray-100 hover:shadow-xl transition-all duration-300 h-full">
                        ...
                        <h4 class="text-xl font-bold text-[#0B2035] mb-3">Ongoing Support</h4>
                        <p class="text-gray-500 font-light leading-relaxed text-sm">Monthly follow-up visits to monitor progress, adjust dosages, address side effects, and provide nutritional and behavioral coaching.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="py-16 bg-neutral relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center max-w-3xl mx-auto mb-20 reveal">
                <h2 class="text-sm font-bold tracking-widest text-[#23bfe2] uppercase mb-4">Beyond Weight Loss</h2>
                <h3 class="text-4xl md:text-5xl font-bold text-primary mb-6">Comprehensive Health Benefits</h3>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-neutral rounded-[2rem] p-10 shadow-soft border border-gray-100 hover:-translate-y-2 hover:shadow-2xl transition-all duration-300 reveal group flex flex-col items-center text-center">
                    ...
                    <h4 class="text-2xl font-bold text-primary mb-4">Cardiovascular Health</h4>
                    <p class="text-gray-500 font-light leading-relaxed">Reduces major adverse cardiovascular events including heart attacks and strokes.</p>
                </div>
                ...
                <div class="bg-neutral rounded-[2rem] p-10 shadow-soft border border-gray-100 hover:-translate-y-2 hover:shadow-2xl transition-all duration-300 reveal reveal-delay-1 group flex flex-col items-center text-center">
                    ...
                    <h4 class="text-2xl font-bold text-primary mb-4">Blood Sugar Control</h4>
                    <p class="text-gray-500 font-light leading-relaxed">Improves insulin sensitivity and helps regulate blood sugar levels.</p>
                </div>
                ...
                <div class="bg-neutral rounded-[2rem] p-10 shadow-soft border border-gray-100 hover:-translate-y-2 hover:shadow-2xl transition-all duration-300 reveal reveal-delay-2 group flex flex-col items-center text-center">
                    ...
                    <h4 class="text-2xl font-bold text-primary mb-4">Blood Pressure</h4>
                    <p class="text-gray-500 font-light leading-relaxed">Clinically shown to lower blood pressure and reduce hypertension risk.</p>
                </div>
                ...
                <div class="bg-neutral rounded-[2rem] p-10 shadow-soft border border-gray-100 hover:-translate-y-2 hover:shadow-2xl transition-all duration-300 reveal group flex flex-col items-center text-center">
                    ...
                    <h4 class="text-2xl font-bold text-primary mb-4">Sleep Quality</h4>
                    <p class="text-gray-500 font-light leading-relaxed">Reduced obesity improves sleep apnea and overall sleep quality.</p>
                </div>
                ...
                <div class="bg-neutral rounded-[2rem] p-10 shadow-soft border border-gray-100 hover:-translate-y-2 hover:shadow-2xl transition-all duration-300 reveal reveal-delay-1 group flex flex-col items-center text-center">
                    ...
                    <h4 class="text-2xl font-bold text-primary mb-4">Mental Wellness</h4>
                    <p class="text-gray-500 font-light leading-relaxed">Weight loss has been shown to improve mood, self-esteem, and reduce symptoms of depression.</p>
                </div>
                ...
                <div class="bg-neutral rounded-[2rem] p-10 shadow-soft border border-gray-100 hover:-translate-y-2 hover:shadow-2xl transition-all duration-300 reveal reveal-delay-2 group flex flex-col items-center text-center">
                    ...
                    <h4 class="text-2xl font-bold text-primary mb-4">Reduced Complications</h4>
                    <p class="text-gray-500 font-light leading-relaxed">Lowers risk of obesity-related complications including chronic pain, joint issues, and metabolic syndrome.</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="space-y-4">
                ...
                <div class="bg-white/5 border border-white/10 rounded-2xl overflow-hidden reveal">
                    <button class="faq-toggle w-full px-8 py-6 text-left font-bold text-xl flex items-center justify-between focus:outline-none hover:bg-white/5 transition-colors group">
                        <span>What medications do you prescribe for weight loss?</span>
                    ...
                    <div class="px-8 pb-8 text-gray-300 font-light leading-relaxed text-lg hidden faq-content">
                        <div class="pt-2 border-t border-white/10 mt-2">
                            We offer FDA-approved GLP-1 receptor agonists including semaglutide (the active ingredient in Ozempic/Wegovy) and tirzepatide (the active ingredient in Mounjaro/Zepbound). Your provider will recommend the best option based on your health profile and goals.
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white/5 border border-white/10 rounded-2xl overflow-hidden reveal">
                    ...
                    <div class="px-8 pb-8 text-gray-300 font-light leading-relaxed text-lg hidden faq-content">
                        <div class="pt-2 border-t border-white/10 mt-2">
                            Most patients begin noticing appetite reduction within the first 1-2 weeks. Significant weight loss typically becomes apparent within the first month, with continued progress over 3-6 months as doses are optimized.
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white/5 border border-white/10 rounded-2xl overflow-hidden reveal">
                    ...
                    <div class="px-8 pb-8 text-gray-300 font-light leading-relaxed text-lg hidden faq-content">
                        <div class="pt-2 border-t border-white/10 mt-2">
                            Common side effects include mild nausea, which typically decreases over time as your body adjusts. Your provider monitors you closely and adjusts dosing to minimize any discomfort.
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white/5 border border-white/10 rounded-2xl overflow-hidden reveal">
                    <button class="faq-toggle w-full px-8 py-6 text-left font-bold text-xl flex items-center justify-between focus:outline-none hover:bg-white/5 transition-colors group">
                        <span>Is the weight loss program covered by insurance?</span>
                        <div class="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-[#23bfe2] group-hover:bg-[#23bfe2] group-hover:text-[#0B2035] transition-colors">
                            <i data-lucide="plus" class="w-5 h-5 transition-transform duration-300"></i>
                        </div>
                    </button>
                    <div class="px-8 pb-8 text-gray-300 font-light leading-relaxed text-lg hidden faq-content">
                        <div class="pt-2 border-t border-white/10 mt-2">
                            Medical weight loss consultations may be covered by insurance. GLP-1 medications may require prior authorization or may be self-pay depending on your plan. Our team helps verify your coverage.
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white/5 border border-white/10 rounded-2xl overflow-hidden reveal">
                    <button class="faq-toggle w-full px-8 py-6 text-left font-bold text-xl flex items-center justify-between focus:outline-none hover:bg-white/5 transition-colors group">
                        <span>Can I do virtual visits for weight loss?</span>
                        <div class="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-[#23bfe2] group-hover:bg-[#23bfe2] group-hover:text-[#0B2035] transition-colors">
                            <i data-lucide="plus" class="w-5 h-5 transition-transform duration-300"></i>
                        </div>
                    </button>
                    <div class="px-8 pb-8 text-gray-300 font-light leading-relaxed text-lg hidden faq-content">
                        <div class="pt-2 border-t border-white/10 mt-2">
                            Yes! Both initial consultations and follow-up visits can be conducted via secure telehealth. Prescriptions can be sent directly to your pharmacy.
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="py-16 relative overflow-hidden bg-white">
        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10 reveal">
            <h2 class="text-4xl md:text-5xl lg:text-6xl font-bold text-[#0B2035] mb-8 leading-tight">
                Ready to <span class="text-transparent bg-clip-text bg-gradient-to-r from-[#23bfe2] to-[#1da1bf]">Transform Your Health</span>?
            </h2>
            <p class="text-xl text-gray-600 mb-12 font-light max-w-2xl mx-auto leading-relaxed">
                Take the first step toward sustainable weight loss with physician-supervised care. Schedule your consultation today.
            </p>
