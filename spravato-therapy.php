...
<main>
    ...
    <section class="relative h-[60vh] min-h-[500px] flex items-center justify-center overflow-hidden pt-24">
        ...
        <div class="absolute inset-0 z-0 bg-[#0B2035]">
            <img src="assets/images/anxiety_consultation.png" alt="Spravato Treatment Consultation" class="w-full h-full object-cover">
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
            <div class="max-w-3xl reveal text-left">
                <div class="flex items-center gap-3 mb-6">
                    ...
                    <span class="text-[#23bfe2] text-sm font-bold tracking-widest uppercase">Esketamine Nasal Spray</span>
                </div>
                <h1 class="text-4xl md:text-5xl lg:text-7xl font-bold text-white tracking-tight leading-tight mb-6">
                    SPRAVATO&reg; <br/><span class="text-[#23bfe2] font-light">Treatment</span>
                </h1>
            ...
            <div class="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
                ...
                <div class="w-full lg:w-1/2 relative reveal reveal-delay-1">
                    <div class="relative rounded-[2.5rem] overflow-hidden shadow-2xl border border-gray-100">
                        <img src="assets/images/depression_relief.png" alt="Spravato Treatment relief" class="w-full h-[500px] object-cover">
            ...
            <div class="columns-1 md:columns-2 lg:columns-3 gap-6 space-y-6">
                ...
                <div class="break-inside-avoid bg-white border border-gray-100 p-8 rounded-[2rem] shadow-sm hover:shadow-lg transition-all duration-300 group">
                    ...
                    <p class="text-gray-700 text-sm leading-relaxed mb-8 font-light italic">
                        "I had tried everything for my depression. Spravato was the first thing that actually worked, and it worked quickly. The staff at Resiliency made the 2-hour observation time feel like a spa visit."
                    </p>
                    <div class="flex items-center gap-3 border-t border-gray-50 pt-6">
                        <div class="w-10 h-10 rounded-full bg-[#23bfe2]/10 text-primary flex items-center justify-center font-bold text-xs">AJ</div>
                        <span class="font-bold text-gray-800 text-sm">Amanda J.</span>
                    </div>
                </div>
                ...
                <div class="break-inside-avoid bg-white border border-gray-100 p-8 rounded-[2rem] shadow-sm hover:shadow-lg transition-all duration-300 group">
                    ...
                    <p class="text-gray-700 text-sm leading-relaxed mb-8 font-light italic">
                        "The medical team is so professional and caring. I felt completely safe and supported during the observation periods. It's been life-changing for my mental health."
                    </p>
                    <div class="flex items-center gap-3 border-t border-gray-50 pt-6">
                        <div class="w-10 h-10 rounded-full bg-pink-50 text-pink-600 flex items-center justify-center font-bold text-xs">RK</div>
                        <span class="font-bold text-gray-800 text-sm">Robert K.</span>
                    </div>
                </div>
                ...
                <div class="break-inside-avoid bg-white border border-gray-100 p-8 rounded-[2rem] shadow-sm hover:shadow-lg transition-all duration-300 group">
                    ...
                    <p class="text-gray-700 text-sm leading-relaxed mb-8 font-light italic">
                        "The quick onset of relief was what amazed me. After years of struggling, I finally feel like I have my life back. Resiliency is truly the best place for this treatment."
                    </p>
                    <div class="flex items-center gap-3 border-t border-gray-50 pt-6">
                        <div class="w-10 h-10 rounded-full bg-indigo-50 text-indigo-600 flex items-center justify-center font-bold text-xs">LM</div>
                        <span class="font-bold text-gray-800 text-sm">Lori M.</span>
                    </div>
                </div>
            </div>
        </div>
