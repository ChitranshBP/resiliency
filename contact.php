        ...
        <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
            <div class="max-w-3xl reveal text-left">
                <div class="flex items-center gap-3 mb-6">
                    ...
                    <span class="text-[#23bfe2] text-sm font-bold tracking-widest uppercase">Get In Touch</span>
                </div>
                <h1 class="text-4xl md:text-5xl lg:text-7xl font-bold text-white tracking-tight leading-tight mb-6">
                    Contact <br/><span class="text-[#23bfe2] font-light">Us</span>
                </h1>
                ...
                <div class="w-full lg:w-5/12 reveal">
                    ...
                    <div class="space-y-6 mb-10">
                        ...
                        <div class="flex items-center gap-5">
                            ...
                            <div>
                                <p class="text-xs text-gray-400 font-bold uppercase tracking-widest mb-1">Free Consultation</p>
