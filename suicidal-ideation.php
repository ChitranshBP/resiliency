<?php
$page_title       = 'Suicidal Ideation Treatment in Newport Beach & San Juan Capistrano | Resiliency Mind + Body Medicine®';
$page_description = 'Compassionate treatment for suicidal ideation in Newport Beach & San Juan Capistrano, CA. Spravato & Deep TMS provide rapid relief for crisis situations.';
$page_keywords    = 'suicidal ideation treatment Newport Beach, crisis care San Juan Capistrano, Spravato suicidal ideation Orange County, depression crisis treatment Newport Beach CA';
...
<main>
    ...
    <section class="relative min-h-[500px] md:h-[60vh] flex items-center justify-center overflow-hidden pt-28 pb-12 md:pt-24 md:pb-0">
        <div class="absolute inset-0 z-0 bg-[#0B2035]">
            <img src="assets/images/suicidal_ideation_hero.png" alt="Suicidal Ideation Hope & Healing" class="w-full h-full object-cover object-[50%_25%]">
    ...
    <section class="py-16 relative overflow-hidden bg-white">
        <div class="absolute inset-0 z-0">
            <img src="assets/images/anxiety_relief.png" alt="Path to Hope" class="w-full h-full object-cover opacity-10">
