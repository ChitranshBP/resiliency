<?php /* Template Name: Integrative Psychiatry */ ?>
<?php
...
<main>
    ...
    <section class="relative min-h-[500px] md:h-[60vh] flex items-center justify-center overflow-hidden pt-28 pb-12 md:pt-24 md:pb-0">
        ...
        <div class="absolute inset-0 z-0 bg-[#0B2035]">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/philosophy_bg.png" alt="Integrative Psychiatry" class="w-full h-full object-cover">
                ...
                <div class="w-full lg:w-1/2 reveal">
                    <div class="relative group">
                        ...
                        <div class="relative rounded-[3rem] overflow-hidden shadow-2xl border-4 border-white ring-1 ring-gray-100">
                            <img
                                src="<?php echo get_template_directory_uri(); ?>/assets/images/home/Stefani-LaFrenierre-main-home.webp"
    ...
    <section class="py-12 bg-gray-50 border-t border-gray-100">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-wrap gap-3">
                ...
                <a href="<?php echo esc_url(home_url('/hormone-therapy/')); ?>" class="inline-flex items-center gap-2 px-5 py-2.5 rounded-full border border-[#0B2035]/15 text-[#0B2035] text-sm font-medium hover:bg-[#0B2035] hover:text-white transition-all">Hormone Therapy</a>
                <a href="<?php echo esc_url(home_url('/nad-iv-therapy/')); ?>" class="inline-flex items-center gap-2 px-5 py-2.5 rounded-full border border-[#0B2035]/15 text-[#0B2035] text-sm font-medium hover:bg-[#0B2035] hover:text-white transition-all">NAD+ Therapy</a>
                <a href="<?php echo esc_url(home_url('/iv-therapy-newport-beach-ca/')); ?>" class="inline-flex items-center gap-2 px-5 py-2.5 rounded-full border border-[#0B2035]/15 text-[#0B2035] text-sm font-medium hover:bg-[#0B2035] hover:text-white transition-all">IV Vitamin Therapy</a>
