<?php /* Template Name: Insurance & Fees */ ?>
<?php get_header(); ?>
...
<main>
    ...
    <section class="relative min-h-[500px] md:h-[60vh] flex items-center justify-center overflow-hidden pt-28 pb-12 md:pt-24 md:pb-0">
        ...
        <div class="absolute inset-0 z-0 bg-[#0B2035]">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/hero_bg.png" alt="Insurance and Payment Options" class="w-full h-full object-cover">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6 reveal">
                ...
                <div class="bg-white rounded-2xl p-6 shadow-soft border border-gray-100 hover:-translate-y-1 hover:shadow-xl transition-all duration-300 flex flex-col items-center justify-center min-h-[140px]">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/insurance/aetna.webp" alt="Aetna" class="max-h-16 w-auto object-contain mb-3">
                    <p class="text-[#0B2035] font-semibold text-xs">Aetna</p>
                </div>
                <!-- Anthem Blue Cross Blue Shield -->
                <div class="bg-white rounded-2xl p-6 shadow-soft border border-gray-100 hover:-translate-y-1 hover:shadow-xl transition-all duration-300 flex flex-col items-center justify-center min-h-[140px]">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/insurance/anthem.webp" alt="Anthem Blue Cross Blue Shield" class="max-h-16 w-auto object-contain mb-3">
                    <p class="text-[#0B2035] font-semibold text-xs">Anthem BCBS</p>
                </div>
                <!-- Blue Shield of California -->
                <div class="bg-white rounded-2xl p-6 shadow-soft border border-gray-100 hover:-translate-y-1 hover:shadow-xl transition-all duration-300 flex flex-col items-center justify-center min-h-[140px]">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/insurance/blue-california.webp" alt="Blue Shield of California" class="max-h-16 w-auto object-contain mb-3">
                    <p class="text-[#0B2035] font-semibold text-xs">Blue Shield of CA</p>
                </div>
                <!-- CalOptima Health -->
                <div class="bg-white rounded-2xl p-6 shadow-soft border border-gray-100 hover:-translate-y-1 hover:shadow-xl transition-all duration-300 flex flex-col items-center justify-center min-h-[140px]">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/insurance/caloptima.svg" alt="CalOptima Health" class="max-h-16 w-auto object-contain mb-3">
                    <p class="text-[#0B2035] font-semibold text-xs">CalOptima Health</p>
                </div>
                <!-- Cigna -->
                <div class="bg-white rounded-2xl p-6 shadow-soft border border-gray-100 hover:-translate-y-1 hover:shadow-xl transition-all duration-300 flex flex-col items-center justify-center min-h-[140px]">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/insurance/cigna.webp" alt="Cigna Healthcare" class="max-h-16 w-auto object-contain mb-3">
                    <p class="text-[#0B2035] font-semibold text-xs">Cigna Healthcare</p>
                </div>
                <!-- Health Net -->
                <div class="bg-white rounded-2xl p-6 shadow-soft border border-gray-100 hover:-translate-y-1 hover:shadow-xl transition-all duration-300 flex flex-col items-center justify-center min-h-[140px]">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/insurance/health-net.png" alt="Health Net" class="max-h-16 w-auto object-contain mb-3">
                    <p class="text-[#0B2035] font-semibold text-xs">Health Net</p>
                </div>
                <!-- Hoag Medical Group -->
                <div class="bg-white rounded-2xl p-6 shadow-soft border border-gray-100 hover:-translate-y-1 hover:shadow-xl transition-all duration-300 flex flex-col items-center justify-center min-h-[140px]">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/insurance/hoag.jpeg" alt="Hoag Medical Group" class="max-h-16 w-auto object-contain mb-3">
                    <p class="text-[#0B2035] font-semibold text-xs">Hoag Medical Group</p>
                </div>
                <!-- Magellan Health -->
                <div class="bg-white rounded-2xl p-6 shadow-soft border border-gray-100 hover:-translate-y-1 hover:shadow-xl transition-all duration-300 flex flex-col items-center justify-center min-h-[140px]">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/insurance/magellan.webp" alt="Magellan Health" class="max-h-16 w-auto object-contain mb-3">
                    <p class="text-[#0B2035] font-semibold text-xs">Magellan Health</p>
                </div>
                <!-- Medicare -->
                <div class="bg-white rounded-2xl p-6 shadow-soft border border-gray-100 hover:-translate-y-1 hover:shadow-xl transition-all duration-300 flex flex-col items-center justify-center min-h-[140px]">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/insurance/medicare.webp" alt="Medicare" class="max-h-16 w-auto object-contain mb-3">
                    <p class="text-[#0B2035] font-semibold text-xs">Medicare</p>
                </div>
                <!-- MHN -->
                <div class="bg-white rounded-2xl p-6 shadow-soft border border-gray-100 hover:-translate-y-1 hover:shadow-xl transition-all duration-300 flex flex-col items-center justify-center min-h-[140px]">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/insurance/mhn.jpeg" alt="MHN - Managed Health Network" class="max-h-16 w-auto object-contain mb-3">
                    <p class="text-[#0B2035] font-semibold text-xs">MHN</p>
                </div>
                <!-- Optum -->
                <div class="bg-white rounded-2xl p-6 shadow-soft border border-gray-100 hover:-translate-y-1 hover:shadow-xl transition-all duration-300 flex flex-col items-center justify-center min-h-[140px]">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/insurance/optum.webp" alt="Optum" class="max-h-16 w-auto object-contain mb-3">
                    <p class="text-[#0B2035] font-semibold text-xs">Optum</p>
                </div>
                <!-- SCAN -->
                <div class="bg-white rounded-2xl p-6 shadow-soft border border-gray-100 hover:-translate-y-1 hover:shadow-xl transition-all duration-300 flex flex-col items-center justify-center min-h-[140px]">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/insurance/scan.png" alt="SCAN Health Plan" class="max-h-16 w-auto object-contain mb-3">
                    <p class="text-[#0B2035] font-semibold text-xs">SCAN Health Plan</p>
                </div>
                <!-- TriCare -->
                <div class="bg-white rounded-2xl p-6 shadow-soft border border-gray-100 hover:-translate-y-1 hover:shadow-xl transition-all duration-300 flex flex-col items-center justify-center min-h-[140px]">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/insurance/tricare.webp" alt="TriCare" class="max-h-16 w-auto object-contain mb-3">
                    <p class="text-[#0B2035] font-semibold text-xs">TriCare</p>
                </div>
                <!-- TriWest Healthcare Alliance -->
                <div class="bg-white rounded-2xl p-6 shadow-soft border border-gray-100 hover:-translate-y-1 hover:shadow-xl transition-all duration-300 flex flex-col items-center justify-center min-h-[140px]">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/insurance/triwest.png" alt="TriWest Healthcare Alliance" class="max-h-16 w-auto object-contain mb-3">
    ...
    <section class="py-16 relative overflow-hidden bg-white">
        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10 reveal">
            ...
            <div class="flex flex-col sm:flex-row justify-center gap-6 items-center">
                ...
                <a href="<?php echo esc_url(home_url('/contact/')); ?>" class="inline-flex items-center gap-2 text-[#0B2035] font-bold hover:text-[#23bfe2] transition-colors text-lg">
