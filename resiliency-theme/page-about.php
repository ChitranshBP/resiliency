...
<main>
    ...
    <section class="relative min-h-[500px] md:h-[60vh] flex items-center justify-center overflow-hidden pt-28 pb-12 md:pt-24 md:pb-0">
        ...
        <div class="absolute inset-0 z-0 bg-[#0B2035]">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/hero_bg.png" alt="About Resiliency Mind Body Medicine" class="w-full h-full object-cover">
            ...
            <div class="flex flex-col lg:flex-row items-center gap-16 lg:gap-20">
                ...
                <div class="w-full lg:w-1/2 relative reveal reveal-delay-1">
                    <div class="relative rounded-[2.5rem] overflow-hidden shadow-2xl border border-gray-100 ring-1 ring-[#0B2035]/5">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/home/Resiliency01.webp" alt="Resiliency Mind Body Medicine clinic" class="w-full h-[550px] object-cover">
                ...
                <div class="w-full lg:w-1/2 reveal">
                    <div class="relative group">
                        ...
                        <div class="relative rounded-[3rem] overflow-hidden shadow-2xl border-4 border-white/10 ring-1 ring-white/5">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/home/Stefani-LaFrenierre-main-home.webp" alt="Dr. Stefani LaFrenierre, MD" class="w-full h-[550px] object-cover object-top transition-all duration-700 group-hover:scale-105">
    ...
    <section class="py-16 bg-white relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mb-12">
                ...
                <a href="<?php echo esc_url(home_url('/our-team/')); ?>" class="group reveal">
                ...
                <!-- Dr. Heather Wong -->
                <a href="<?php echo esc_url(home_url('/our-team/')); ?>" class="group reveal reveal-delay-1">
                    <div class="bg-neutral rounded-[2rem] overflow-hidden border border-gray-100 hover:-translate-y-2 hover:shadow-2xl transition-all duration-300">
                        <div class="h-56 overflow-hidden">
                ...
                <!-- Milinda Estrada -->
                <a href="<?php echo esc_url(home_url('/our-team/')); ?>" class="group reveal reveal-delay-2">
                    <div class="bg-neutral rounded-[2rem] overflow-hidden border border-gray-100 hover:-translate-y-2 hover:shadow-2xl transition-all duration-300">
                        <div class="h-56 overflow-hidden">
                ...
                <!-- Regina Dizon -->
                <a href="<?php echo esc_url(home_url('/our-team/')); ?>" class="group reveal reveal-delay-3">
                    <div class="bg-neutral rounded-[2rem] overflow-hidden border border-gray-100 hover:-translate-y-2 hover:shadow-2xl transition-all duration-300">
                        <div class="h-56 overflow-hidden">
            ...
            <div class="text-center reveal">
                <a href="<?php echo esc_url(home_url('/our-team/')); ?>" class="group relative inline-flex items-center justify-center bg-[#0B2035] hover:bg-[#23bfe2] text-white hover:text-[#0B2035] font-bold px-10 py-4 rounded-full transition-all duration-300 shadow-xl hover:-translate-y-1 hover:shadow-2xl">
