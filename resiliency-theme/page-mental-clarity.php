<?php /* Template Name: Mental Clarity */ ?>
<?php
...
<script type="application/ld+json">
{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"What causes brain fog?","acceptedAnswer":{"@type":"Answer","text":"Brain fog can be caused by depression, anxiety, hormonal imbalances, nutritional deficiencies, sleep disorders, thyroid dysfunction, chronic inflammation, or post-COVID syndrome."}},{"@type":"Question","name":"How do you diagnose the cause of brain fog?","acceptedAnswer":{"@type":"Answer","text":"We perform a comprehensive evaluation including psychiatric assessment, metabolic labs, thyroid panel, hormonal testing, and nutritional analysis to identify the root cause."}},{"@type":"Question","name":"How quickly will I notice improvement in mental clarity?","acceptedAnswer":{"@type":"Answer","text":"Results vary by cause. Nutritional deficiencies may improve within weeks; hormonal and metabolic issues may take 1-3 months. NAD+ therapy often produces rapid improvements in clarity and energy."}},{"@type":"Question","name":"Can brain fog be a sign of a more serious condition?","acceptedAnswer":{"@type":"Answer","text":"Yes. Persistent brain fog can signal depression, hormonal imbalances, thyroid disorders, or nutritional deficiencies. Our team investigates root causes before recommending treatment."}},{"@type":"Question","name":"Can mental clarity treatments be done via telehealth?","acceptedAnswer":{"@type":"Answer","text":"Initial evaluation and nutritional/medication management can be done via telehealth. IV NAD+ therapy and in-office treatments require an in-person visit in Newport Beach or San Juan Capistrano."}},{"@type":"Question","name":"Do you treat post-COVID brain fog?","acceptedAnswer":{"@type":"Answer","text":"Yes. Post-COVID cognitive symptoms including brain fog, memory issues, and concentration difficulties respond well to our integrative approach combining NAD+ therapy, nutritional optimization, and targeted supplements."}}]}
</script>
SCHEMA;
?>
<?php get_header(); ?>
...
<main>
    ...
    <section class="relative min-h-[500px] md:h-[60vh] flex items-center justify-center overflow-hidden pt-28 pb-12 md:pt-24 md:pb-0">
        <div class="absolute inset-0 z-0 bg-[#0B2035]">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/home/Resiliency01.webp" alt="Mental Clarity Treatment" class="w-full h-full object-cover object-[80%_60%]">
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
            <div class="max-w-3xl reveal text-left">
                <div class="flex items-center gap-3 mb-4 sm:mb-6">
                    ...
                    <span class="text-[#23bfe2] text-xs sm:text-sm font-bold tracking-widest uppercase">Cognitive Wellness</span>
                </div>
                <h1 class="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-bold text-white tracking-tight leading-tight mb-4 sm:mb-6">
                    Mental <span class="text-[#23bfe2] font-light">Clarity</span>
            ...
            <div class="flex flex-col lg:flex-row items-center gap-16 lg:gap-20">
                <div class="w-full lg:w-1/2 text-[#0B2035] reveal">
                    <div class="flex items-center gap-3 mb-4">
                        <span class="h-[2px] w-12 bg-[#23bfe2]"></span>
                        <h2 class="text-sm font-bold tracking-widest text-[#23bfe2] uppercase">Understanding Brain Fog</h2>
                    </div>
                    <h3 class="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">Restore Your Mental Sharpness</h3>
                ...
                <div class="w-full lg:w-1/2 relative reveal reveal-delay-1">
                    <div class="relative rounded-[2.5rem] overflow-hidden shadow-2xl border border-gray-100 ring-1 ring-[#0B2035]/5">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/home/Resiliency01.webp" alt="Mental Clarity Treatment at Resiliency" class="w-full h-[450px] object-cover">
    ...
    <section class="py-16 bg-[#0B2035] relative overflow-hidden text-white border-t border-white/10">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="text-center max-w-3xl mx-auto mb-16 reveal">
                ...
                <h3 class="text-4xl md:text-5xl font-bold">How We Restore Mental Clarity</h3>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div class="bg-white/5 border border-white/10 rounded-[2rem] p-8 hover:-translate-y-2 transition-all duration-300 reveal group flex flex-col items-center text-center">
                    ...
                    <h4 class="text-xl font-bold mb-3">Cognitive Assessment</h4>
                    <p class="text-gray-300 font-light leading-relaxed">Comprehensive psychiatric and metabolic evaluation to identify causes of brain fog.</p>
                </div>
                ...
                <div class="bg-white/5 border border-white/10 rounded-[2rem] p-8 hover:-translate-y-2 transition-all duration-300 reveal reveal-delay-1 group flex flex-col items-center text-center">
                    ...
                    <h4 class="text-xl font-bold mb-3">Nutritional Optimization</h4>
                    <p class="text-gray-300 font-light leading-relaxed">Targeted supplements, IV therapy, and dietary guidance for brain health.</p>
                </div>
                ...
                <div class="bg-white/5 border border-white/10 rounded-[2rem] p-8 hover:-translate-y-2 transition-all duration-300 reveal reveal-delay-2 group flex flex-col items-center text-center">
                    ...
                    <h4 class="text-xl font-bold mb-3">Hormone Assessment</h4>
                    <p class="text-gray-300 font-light leading-relaxed">Evaluation of thyroid, cortisol, testosterone, and other hormones affecting cognition.</p>
                </div>
                ...
                <div class="bg-white/5 border border-white/10 rounded-[2rem] p-8 hover:-translate-y-2 transition-all duration-300 reveal reveal-delay-3 group flex flex-col items-center text-center">
                    ...
                    <h4 class="text-xl font-bold mb-3">NAD+ Therapy</h4>
                    <p class="text-gray-300 font-light leading-relaxed">IV NAD+ to support mitochondrial function and cellular energy for sharper thinking.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-neutral relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center max-w-3xl mx-auto mb-16 reveal">
                <h2 class="text-sm font-bold tracking-widest text-[#23bfe2] uppercase mb-4">Expected Outcomes</h2>
                <h3 class="text-4xl md:text-5xl font-bold text-[#0B2035] mb-6">Benefits of Treatment</h3>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
                <div class="bg-white rounded-[2rem] p-8 shadow-soft border border-gray-100 hover:-translate-y-2 hover:shadow-2xl transition-all duration-300 reveal group text-center">
                    <div class="w-14 h-14 bg-[#23bfe2]/10 rounded-2xl flex items-center justify-center text-[#23bfe2] mb-6 group-hover:bg-[#23bfe2] group-hover:text-[#0B2035] transition-colors mx-auto">
                        <i data-lucide="focus" class="w-7 h-7"></i>
                    </div>
                    <h4 class="text-lg font-bold text-[#0B2035]">Improved Focus & Concentration</h4>
                </div>
                ...
                <div class="bg-white rounded-[2rem] p-8 shadow-soft border border-gray-100 hover:-translate-y-2 hover:shadow-2xl transition-all duration-300 reveal reveal-delay-1 group text-center">
                    ...
                    <h4 class="text-lg font-bold text-[#0B2035]">Reduced Brain Fog</h4>
                </div>
                ...
                <div class="bg-white rounded-[2rem] p-8 shadow-soft border border-gray-100 hover:-translate-y-2 hover:shadow-2xl transition-all duration-300 reveal reveal-delay-2 group text-center">
                    ...
                    <h4 class="text-lg font-bold text-[#0B2035]">Better Memory & Recall</h4>
                </div>
                ...
                <div class="bg-white rounded-[2rem] p-8 shadow-soft border border-gray-100 hover:-translate-y-2 hover:shadow-2xl transition-all duration-300 reveal reveal-delay-3 group text-center">
                    ...
                    <h4 class="text-lg font-bold text-[#0B2035]">Enhanced Mental Energy</h4>
                </div>
                ...
                <div class="bg-white rounded-[2rem] p-8 shadow-soft border border-gray-100 hover:-translate-y-2 hover:shadow-2xl transition-all duration-300 reveal group text-center">
                    ...
                    <h4 class="text-lg font-bold text-[#0B2035]">Restored Cognitive Performance</h4>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="space-y-4">
                <div class="bg-white/5 border border-white/10 rounded-2xl overflow-hidden reveal">
                    <button class="faq-toggle w-full px-8 py-6 text-left font-bold text-xl flex items-center justify-between focus:outline-none hover:bg-white/5 transition-colors group">
                        <span>What causes brain fog?</span>
                    ...
                    <div class="px-8 pb-8 text-gray-300 font-light leading-relaxed text-lg hidden faq-content">
                        <div class="pt-2 border-t border-white/10 mt-2">
                            Common causes include depression, anxiety, poor sleep, nutritional deficiencies, hormonal imbalances, chronic stress, and medication side effects.
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white/5 border border-white/10 rounded-2xl overflow-hidden reveal">
                    <button class="faq-toggle w-full px-8 py-6 text-left font-bold text-xl flex items-center justify-between focus:outline-none hover:bg-white/5 transition-colors group">
                        <span>How do you diagnose the cause?</span>
                        <div class="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-[#23bfe2] group-hover:bg-[#23bfe2] group-hover:text-[#0B2035] transition-colors">
                            <i data-lucide="plus" class="w-5 h-5 transition-transform duration-300"></i>
                        </div>
                    </button>
                    <div class="px-8 pb-8 text-gray-300 font-light leading-relaxed text-lg hidden faq-content">
                        <div class="pt-2 border-t border-white/10 mt-2">
                            We perform comprehensive psychiatric evaluation plus metabolic lab work to identify underlying contributors.
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white/5 border border-white/10 rounded-2xl overflow-hidden reveal">
                    <button class="faq-toggle w-full px-8 py-6 text-left font-bold text-xl flex items-center justify-between focus:outline-none hover:bg-white/5 transition-colors group">
                        <span>How quickly will I notice improvement?</span>
                        <div class="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-[#23bfe2] group-hover:bg-[#23bfe2] group-hover:text-[#0B2035] transition-colors">
                            <i data-lucide="plus" class="w-5 h-5 transition-transform duration-300"></i>
                        </div>
                    </button>
                    <div class="px-8 pb-8 text-gray-300 font-light leading-relaxed text-lg hidden faq-content">
                        <div class="pt-2 border-t border-white/10 mt-2">
                            Many patients notice improvement within weeks of starting targeted treatment, especially with IV NAD+ and nutritional interventions.
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white/5 border border-white/10 rounded-2xl overflow-hidden reveal">
                    <button class="w-full px-8 py-6 text-left font-bold text-xl flex items-center justify-between focus:outline-none hover:bg-white/5 transition-colors group">
                        <span>Can brain fog be a sign of a more serious medical condition?</span>
                        <div class="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-[#23bfe2] group-hover:bg-[#23bfe2] group-hover:text-[#0B2035] transition-colors">
                            <i data-lucide="plus" class="w-5 h-5 transition-transform duration-300"></i>
                        </div>
                    </button>
                    <div class="px-8 pb-8 text-gray-300 font-light leading-relaxed text-lg hidden faq-content">
                        <div class="pt-2 border-t border-white/10 mt-2">
                            Yes — persistent brain fog can be linked to depression, anxiety, hormonal imbalances, nutritional deficiencies, sleep disorders, or thyroid dysfunction. At Resiliency, we investigate the root cause before recommending treatment. Our approach may include <a href="<?php echo home_url('/hormone-therapy/'); ?>" class="text-[#23bfe2] underline hover:text-white">hormone therapy</a>, <a href="<?php echo home_url('/nad-therapy/'); ?>" class="text-[#23bfe2] underline hover:text-white">NAD+ IV infusions</a>, or <a href="<?php echo home_url('/integrative-psychiatry/'); ?>" class="text-[#23bfe2] underline hover:text-white">integrative psychiatry</a> to address underlying causes.
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="py-16 relative overflow-hidden bg-white">
        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10 reveal">
            <h2 class="text-4xl md:text-5xl lg:text-6xl font-bold text-[#0B2035] mb-8 leading-tight">
                Restore Your Mental <span class="text-transparent bg-clip-text bg-gradient-to-r from-[#23bfe2] to-[#1da1bf]">Clarity</span>
            </h2>
    ...
    <section class="py-12 bg-gray-50 border-t border-gray-100">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-wrap gap-3">
                <a href="<?php echo home_url('/cognitive-enhancement/'); ?>" class="inline-flex items-center gap-2 px-5 py-2.5 rounded-full border border-[#0B2035]/15 text-[#0B2035] text-sm font-medium hover:bg-[#0B2035] hover:text-white transition-all">Cognitive Enhancement</a>
                <a href="<?php echo home_url('/nad-therapy/'); ?>" class="inline-flex items-center gap-2 px-5 py-2.5 rounded-full border border-[#0B2035]/15 text-[#0B2035] text-sm font-medium hover:bg-[#0B2035] hover:text-white transition-all">NAD+ Therapy</a>
                <a href="<?php echo home_url('/iv-therapy/'); ?>" class="inline-flex items-center gap-2 px-5 py-2.5 rounded-full border border-[#0B2035]/15 text-[#0B2035] text-sm font-medium hover:bg-[#0B2035] hover:text-white transition-all">IV Vitamin Therapy</a>
                ...
                <a href="<?php echo home_url('/tms-for-mental-boost/'); ?>" class="inline-flex items-center gap-2 px-5 py-2.5 rounded-full border border-[#0B2035]/15 text-[#0B2035] text-sm font-medium hover:bg-[#0B2035] hover:text-white transition-all">TMS for Mental Boost</a>
            </div>
        </div>
    </section>
