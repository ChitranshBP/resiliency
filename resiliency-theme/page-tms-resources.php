<?php /* Template Name: Deep TMS Resources */ ?>
<?php get_header(); ?>
...
<main>
    ...
    <section class="relative min-h-[500px] md:h-[60vh] flex items-center justify-center overflow-hidden pt-28 pb-12 md:pt-24 md:pb-0">
        ...
        <div class="absolute inset-0 z-0 bg-[#0B2035]">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/hero_bg.png" alt="Deep TMS Therapy Resources" class="w-full h-full object-cover">
