<?php /* Template Name: TMS Candidacy Quiz */ ?>
<?php
...
<main>
    ...
    <section class="relative min-h-[420px] md:h-[55vh] flex items-center justify-center overflow-hidden pt-28 pb-12 md:pt-24 md:pb-0">
        <div class="absolute inset-0 z-0 bg-[#0B2035]">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/anxiety_consultation.png" alt="TMS Therapy Candidacy Quiz" class="w-full h-full object-cover object-right md:object-[50%_40%]">
    ...
    <section class="py-16 relative overflow-hidden bg-white">
        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10 reveal">
            ...
            <div class="flex flex-col sm:flex-row justify-center gap-4 items-center">
                <a href="<?php echo home_url('/contact'); ?>" class="inline-flex items-center justify-center gap-2 bg-[#0B2035] hover:bg-[#23bfe2] text-white hover:text-[#0B2035] font-bold px-10 py-4 rounded-full transition-all hover:-translate-y-1 shadow-xl">
