<?php /* Template Name: Newport Beach */ ?>
<?php get_header(); ?>
...
<main>
    ...
    <section class="relative min-h-[500px] md:h-[60vh] flex items-center justify-center overflow-hidden pt-28 pb-12 md:pt-24 md:pb-0">
        ...
        <div class="absolute inset-0 z-0 bg-[#0B2035]">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/hero_bg.png" alt="Newport Beach Location - Resiliency Mind Body Medicine" class="w-full h-full object-cover">
    ...
    <section class="py-16 bg-[#0B2035] relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div class="flex flex-col md:flex-row justify-center gap-8 mt-8">
                ...
                <div class="bg-white/5 backdrop-blur-sm rounded-[2rem] p-8 border border-white/10 reveal hover:-translate-y-2 hover:bg-white/10 transition-all duration-300 text-center w-full md:w-[calc(50%-1rem)] lg:w-[calc(33.333%-1.333rem)]">
                    <div class="w-14 h-14 bg-[#23bfe2]/10 rounded-2xl flex items-center justify-center text-[#23bfe2] mb-6 mx-auto">
                ...
                <!-- IV & NAD+ Therapy -->
                <div class="bg-white/5 backdrop-blur-sm rounded-[2rem] p-8 border border-white/10 reveal reveal-delay-1 hover:-translate-y-2 hover:bg-white/10 transition-all duration-300 text-center w-full md:w-[calc(50%-1rem)] lg:w-[calc(33.333%-1.333rem)]">
                    <div class="w-14 h-14 bg-[#23bfe2]/10 rounded-2xl flex items-center justify-center text-[#23bfe2] mb-6 mx-auto">
