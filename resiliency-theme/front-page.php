...
<?php get_header(); ?>
    <main>
            ...
            <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
                <div class="max-w-2xl reveal">
                    ...
                    <div class="flex flex-col sm:flex-row gap-3 sm:gap-4 mb-8 sm:mb-10">
                        <a href="<?php echo esc_url(home_url("/contact/")); ?>" class="bg-lightblue text-primary font-bold px-6 sm:px-8 py-3.5 rounded-full text-center text-sm sm:text-base transition-all hover:bg-[#1aadd0] hover:shadow-lg shadow-md hover:-translate-y-1 transform">
        ...
        <section class="relative max-w-7xl mx-auto mt-4 rounded-3xl overflow-hidden bg-gradient-to-r from-[#0B2035] via-[#0e2841] to-[#0B2035]">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 md:py-6 relative z-10">
                <div class="flex flex-col md:flex-row items-center justify-between gap-4 md:gap-8">
                    ...
                    <!-- CTA -->
                    <a href="<?php echo esc_url(home_url("/contact/")); ?>" class="group inline-flex items-center justify-center gap-2 bg-[#23bfe2] hover:bg-white text-[#0B2035] font-bold px-6 md:px-7 py-2.5 md:py-3 rounded-full transition-all hover:-translate-y-0.5 shadow-lg whitespace-nowrap flex-shrink-0 text-sm md:text-base">
                        Take the Quiz
        ...
        <section class="py-12 relative z-20 -mt-8">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="lg:w-1/3 text-center lg:text-left reveal relative z-10 pl-0 lg:pl-4">
                    ...
                    <a href="<?php echo esc_url(home_url("/tms-newportbeach/")); ?>" class="inline-flex items-center gap-2 bg-primary text-white font-bold uppercase tracking-wider text-[10px] px-6 py-2.5 rounded-md transition-all hover:bg-primary/90 hover:shadow-md">
        ...
        <section id="conditions" class="py-16 relative overflow-hidden bg-white">
            ...
            <div class="absolute inset-0 z-0">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/hero_bg.png" alt="Clinical Background" class="w-full h-full object-cover">
            </div>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
                    ...
                    <div class="group relative rounded-[2rem] overflow-hidden min-h-[350px] md:min-h-[420px] flex flex-col justify-end p-8 reveal transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl border border-gray-100/10 cursor-pointer">
                        <!-- Background Image -->
                        <div class="absolute inset-0 z-0">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images\ambience\resiliency-amb-5.webp" alt="Depression Treatment" class="w-full h-full object-cover transition-transform duration-1000 group-hover:scale-110">
                        </div>
                    ...
                    <div class="group relative rounded-[2rem] overflow-hidden min-h-[350px] md:min-h-[420px] flex flex-col justify-end p-8 reveal reveal-delay-1 transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl border border-gray-100/10 cursor-pointer">
                        <!-- Background Image -->
                        <div class="absolute inset-0 z-0">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/doctor_consult.png" alt="Anxiety Consultation" class="w-full h-full object-cover transition-transform duration-1000 group-hover:scale-110">
                        </div>
                        <!-- Overlay Gradient -->
                        <div class="absolute inset-0 z-0 bg-gradient-to-t from-[#0B2035]/80 via-[#0B2035]/40 to-transparent group-hover:opacity-0 transition-opacity duration-500"></div>
                        <!-- Hover Overlay -->
                        ...
                        <div class="relative z-10 flex flex-col h-full justify-end transform transition-transform duration-500">
                            ...
                            <div class="grid grid-rows-[0fr] opacity-0 group-hover:grid-rows-[1fr] group-hover:opacity-100 group-hover:mt-4 transition-all duration-500 ease-in-out">
                                <div class="overflow-hidden flex flex-col">
                                    ...
                                    <a href="<?php echo esc_url(home_url("/tms-for-anxiety-newport-beach-ca/")); ?>" class="inline-flex items-center gap-2 text-white font-semibold tracking-wide uppercase text-xs hover:text-white group-hover:text-[#23bfe2] transition-colors duration-500 mt-auto w-max">
                                        View Protocol <i data-lucide="arrow-right" class="w-4 h-4 transform group-hover:translate-x-1 transition-transform"></i>
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="group relative rounded-[2rem] overflow-hidden min-h-[350px] md:min-h-[420px] flex flex-col justify-end p-8 reveal reveal-delay-2 transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl border border-gray-100/10 cursor-pointer">
                        <!-- Background Image -->
                        <div class="absolute inset-0 z-0">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/brainsway-image.jpg" alt="Deep TMS for OCD" class="w-full h-full object-cover transition-transform duration-1000 group-hover:scale-110">
                        </div>
                        <!-- Overlay Gradient -->
                        <div class="absolute inset-0 z-0 bg-gradient-to-t from-[#0B2035]/80 via-[#0B2035]/40 to-transparent group-hover:opacity-0 transition-opacity duration-500"></div>
                        <!-- Hover Overlay -->
                        ...
                        <div class="relative z-10 flex flex-col h-full justify-end transform transition-transform duration-500">
                            ...
                            <div class="grid grid-rows-[0fr] opacity-0 group-hover:grid-rows-[1fr] group-hover:opacity-100 group-hover:mt-4 transition-all duration-500 ease-in-out">
                                <div class="overflow-hidden flex flex-col">
                                    ...
                                    <a href="<?php echo esc_url(home_url("/tms-for-ocd-newport-beach-ca/")); ?>" class="inline-flex items-center gap-2 text-white font-semibold tracking-wide uppercase text-xs hover:text-white group-hover:text-[#23bfe2] transition-colors duration-500 mt-auto w-max">
                                        View Protocol <i data-lucide="arrow-right" class="w-4 h-4 transform group-hover:translate-x-1 transition-transform"></i>
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="group relative rounded-[2rem] overflow-hidden min-h-[350px] md:min-h-[420px] flex flex-col justify-end p-8 reveal transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl border border-gray-100/10 cursor-pointer">
                        <!-- Background Image -->
                        <div class="absolute inset-0 z-0">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images\ambience\resiliency-amb-4.webp" alt="PTSD Wellness" class="w-full h-full object-cover transition-transform duration-1000 group-hover:scale-110">
                        </div>
                        <!-- Overlay Gradient -->
                        <div class="absolute inset-0 z-0 bg-gradient-to-t from-[#0B2035]/80 via-[#0B2035]/40 to-transparent group-hover:opacity-0 transition-opacity duration-500"></div>
                        <!-- Hover Overlay -->
                        ...
                        <div class="relative z-10 flex flex-col h-full justify-end transform transition-transform duration-500">
                            ...
                            <div class="grid grid-rows-[0fr] opacity-0 group-hover:grid-rows-[1fr] group-hover:opacity-100 group-hover:mt-4 transition-all duration-500 ease-in-out">
                                <div class="overflow-hidden flex flex-col">
                                    ...
                                    <a href="<?php echo esc_url(home_url("/tms-for-ptsd-orange-county/")); ?>" class="inline-flex items-center gap-2 text-white font-semibold tracking-wide uppercase text-xs hover:text-white group-hover:text-[#23bfe2] transition-colors duration-500 mt-auto w-max">
                                        View Protocol <i data-lucide="arrow-right" class="w-4 h-4 transform group-hover:translate-x-1 transition-transform"></i>
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="group relative rounded-[2rem] overflow-hidden min-h-[350px] md:min-h-[420px] flex flex-col justify-end p-8 reveal reveal-delay-1 transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl border border-gray-100/10 cursor-pointer">
                        <!-- Background Image -->
                        <div class="absolute inset-0 z-0">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/service_med_management.png" alt="ADHD Management" class="w-full h-full object-cover transition-transform duration-1000 group-hover:scale-110">
                        </div>
                        <!-- Overlay Gradient -->
                        <div class="absolute inset-0 z-0 bg-gradient-to-t from-[#0B2035]/80 via-[#0B2035]/40 to-transparent group-hover:opacity-0 transition-opacity duration-500"></div>
                        <!-- Hover Overlay -->
                        ...
                        <div class="relative z-10 flex flex-col h-full justify-end transform transition-transform duration-500">
                            ...
                            <div class="grid grid-rows-[0fr] opacity-0 group-hover:grid-rows-[1fr] group-hover:opacity-100 group-hover:mt-4 transition-all duration-500 ease-in-out">
                                <div class="overflow-hidden flex flex-col">
                                    ...
                                    <a href="<?php echo esc_url(home_url("/adhd-treatment-in-orange-county/")); ?>" class="inline-flex items-center gap-2 text-white font-semibold tracking-wide uppercase text-xs hover:text-white group-hover:text-[#23bfe2] transition-colors duration-500 mt-auto w-max">
                                        View Protocol <i data-lucide="arrow-right" class="w-4 h-4 transform group-hover:translate-x-1 transition-transform"></i>
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="group relative rounded-[2rem] overflow-hidden min-h-[350px] md:min-h-[420px] flex flex-col justify-end p-8 reveal transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl border border-gray-100/10 cursor-pointer">
                        <!-- Background Image -->
                        <div class="absolute inset-0 z-0">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/service_iv.png" alt="Mood Disorder Support" class="w-full h-full object-cover transition-transform duration-1000 group-hover:scale-110">
                        </div>
                        <!-- Overlay Gradient -->
                        <div class="absolute inset-0 z-0 bg-gradient-to-t from-[#0B2035]/80 via-[#0B2035]/40 to-transparent group-hover:opacity-0 transition-opacity duration-500"></div>
                        <!-- Hover Overlay -->
                        ...
                        <div class="relative z-10 flex flex-col h-full justify-end transform transition-transform duration-500">
                            ...
                            <div class="grid grid-rows-[0fr] opacity-0 group-hover:grid-rows-[1fr] group-hover:opacity-100 group-hover:mt-4 transition-all duration-500 ease-in-out">
                                <div class="overflow-hidden flex flex-col">
                                    ...
                                    <a href="<?php echo esc_url(home_url("/tms-for-bipolar-disorder/")); ?>" class="inline-flex items-center gap-2 text-white font-semibold tracking-wide uppercase text-xs hover:text-white group-hover:text-[#23bfe2] transition-colors duration-500 mt-auto w-max">
                                        View Protocol <i data-lucide="arrow-right" class="w-4 h-4 transform group-hover:translate-x-1 transition-transform"></i>
                                    </a>
                                </div>
                            </div>
                ...
                <div class="mt-16 text-center reveal">
                    <a href="<?php echo esc_url(home_url("/conditions/")); ?>" class="inline-flex items-center gap-2 bg-[#0B2035] text-white hover:bg-[#23bfe2] hover:text-[#0B2035] font-bold px-10 py-4 rounded-full transition-all duration-300 shadow-xl hover:-translate-y-1">
        ...
        <section id="technology" class="py-16 relative overflow-hidden text-white">
            ...
            <div class="absolute inset-0 z-0">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/anxiety_consultation.png" alt="Clinical Environment Background" class="w-full h-full object-cover">
            </div>
                ...
                <div class="flex flex-col lg:flex-row items-center gap-16 lg:gap-20">
                    ...
                    <div class="w-full lg:w-1/2 relative reveal">
                        ...
                        <div class="relative rounded-[2rem] overflow-hidden border border-white/10 shadow-[0_20px_50px_rgba(35,191,226,0.15)] ring-1 ring-white/20">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/home/TMS-Therapy-Orange-County-homepage.webp" alt="Advanced Deep TMS Machine" class="w-full h-[500px] object-cover transition-transform duration-1000 hover:scale-105">
                    ...
                    <div class="w-full lg:w-1/2 reveal reveal-delay-1 mt-8 lg:mt-0">
                        ...
                        <a href="<?php echo esc_url(home_url("/tms-newportbeach/")); ?>" class="inline-flex items-center justify-center gap-2 bg-white text-primary hover:bg-[#23bfe2] font-bold px-8 py-4 rounded-full transition-all duration-300 shadow-[0_4px_20px_rgba(255,255,255,0.1)] hover:shadow-[0_10px_30px_rgba(35,191,226,0.3)] hover:-translate-y-1">
                ...
                <div class="flex flex-col-reverse lg:flex-row items-center gap-16">
                    ...
                    <div class="w-full lg:w-1/2 relative reveal reveal-delay-1">
                        <div class="relative rounded-[2.5rem] overflow-hidden shadow-hover border border-gray-100">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/home/Resiliency01.webp" alt="Modern Clinic Consultation Room" class="w-full h-[550px] object-cover">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div class="bg-white rounded-2xl flex flex-col h-full border-[2px] border-primary p-6 shadow-sm hover:shadow-md transition-all duration-300 reveal">
                        ...
                        <div class="mb-6">
                            <a href="<?php echo esc_url(home_url("/tms-newportbeach/")); ?>" class="inline-flex items-center gap-1 bg-primary text-white font-bold uppercase tracking-wider text-[11px] px-5 py-2.5 rounded hover:opacity-90 transition-opacity">
                                LEARN MORE <i data-lucide="arrow-up-right" class="w-3 h-3"></i>
                            </a>
                        </div>
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/brainsway-image.jpg" alt="Deep TMS Therapy" class="w-full h-48 object-cover rounded-xl mt-auto">
                    </div>
                    ...
                    <div class="bg-white rounded-2xl flex flex-col h-full border-[2px] border-primary p-6 shadow-sm hover:shadow-md transition-all duration-300 reveal reveal-delay-2">
                        ...
                        <div class="mb-6">
                            <a href="<?php echo esc_url(home_url("/iv-therapy-newport-beach-ca/")); ?>" class="inline-flex items-center gap-1 bg-primary text-white font-bold uppercase tracking-wider text-[11px] px-5 py-2.5 rounded hover:opacity-90 transition-opacity">
                                LEARN MORE <i data-lucide="arrow-up-right" class="w-3 h-3"></i>
                            </a>
                        </div>
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/service_iv.png" alt="IV Drip Therapy" class="w-full h-48 object-cover rounded-xl mt-auto">
                    </div>
                    ...
                    <div class="bg-white rounded-2xl flex flex-col h-full border-[2px] border-primary p-6 shadow-sm hover:shadow-md transition-all duration-300 reveal">
                        ...
                        <div class="mb-6">
                            <a href="<?php echo esc_url(home_url("/weight-loss-in-orange-county/")); ?>" class="inline-flex items-center gap-1 bg-primary text-white font-bold uppercase tracking-wider text-[11px] px-5 py-2.5 rounded hover:opacity-90 transition-opacity">
                                LEARN MORE <i data-lucide="arrow-up-right" class="w-3 h-3"></i>
                            </a>
                        </div>
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/anxiety_consultation.png" alt="Medical Weight Loss" class="w-full h-48 object-cover object-[50%_20%] rounded-xl mt-auto">
                    </div>
                    ...
                    <div class="bg-white rounded-2xl flex flex-col h-full border-[2px] border-primary p-6 shadow-sm hover:shadow-md transition-all duration-300 reveal reveal-delay-1">
                        ...
                        <div class="mb-6">
                            <a href="<?php echo esc_url(home_url("/conservative-medication-management/")); ?>" class="inline-flex items-center gap-1 bg-primary text-white font-bold uppercase tracking-wider text-[11px] px-5 py-2.5 rounded hover:opacity-90 transition-opacity">
                                LEARN MORE <i data-lucide="arrow-up-right" class="w-3 h-3"></i>
                            </a>
                        </div>
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/service_med_management.png" alt="Medical Management" class="w-full h-48 object-cover rounded-xl mt-auto">
                    </div>
                    ...
                    <div class="bg-white rounded-2xl flex flex-col h-full border-[2px] border-primary p-6 shadow-sm hover:shadow-md transition-all duration-300 reveal reveal-delay-2">
                        ...
                        <div class="mb-6">
                            <a href="<?php echo esc_url(home_url("/integrative-psychiatry-orange-county/")); ?>" class="inline-flex items-center gap-1 bg-primary text-white font-bold uppercase tracking-wider text-[11px] px-5 py-2.5 rounded hover:opacity-90 transition-opacity">
                                LEARN MORE <i data-lucide="arrow-up-right" class="w-3 h-3"></i>
                            </a>
                        </div>
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images\ambience\resiliency-amb-1.webp" alt="Wellness Services" class="w-full h-48 object-cover object-[50%_60%] rounded-xl mt-auto">
                    </div>
                </div>
                ...
                <div class="flex flex-col md:flex-row justify-center gap-8 mt-8">
                    ...
                    <div class="bg-white rounded-2xl flex flex-col h-full border-[2px] border-primary p-6 shadow-sm hover:shadow-md transition-all duration-300 reveal w-full md:w-[calc(33.333%-1rem)] lg:w-[calc(33.333%-1.5rem)]">
                        ...
                        <div class="mb-6">
                            <a href="<?php echo esc_url(home_url("/proliv-rx/")); ?>" class="inline-flex items-center gap-1 bg-primary text-white font-bold uppercase tracking-wider text-[11px] px-5 py-2.5 rounded hover:opacity-90 transition-opacity">
                                LEARN MORE <i data-lucide="arrow-up-right" class="w-3 h-3"></i>
                            </a>
                        </div>
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/Proliv™Rx-IMG-FINAL.png" alt="Proliv Rx At-Home Neuromodulation" class="w-full h-48 object-cover rounded-xl mt-auto">
                    </div>
                    ...
                    <div class="bg-white rounded-2xl flex flex-col h-full border-[2px] border-primary p-6 shadow-sm hover:shadow-md transition-all duration-300 reveal reveal-delay-1 w-full md:w-[calc(33.333%-1rem)] lg:w-[calc(33.333%-1.5rem)]">
                        ...
                        <div class="mb-6">
                            <a href="<?php echo esc_url(home_url("/vns-therapy/")); ?>" class="inline-flex items-center gap-1 bg-primary text-white font-bold uppercase tracking-wider text-[11px] px-5 py-2.5 rounded hover:opacity-90 transition-opacity">
                                LEARN MORE <i data-lucide="arrow-up-right" class="w-3 h-3"></i>
                            </a>
                        </div>
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/vns_therapy_device.png" alt="VNS Therapy" class="w-full h-48 object-cover rounded-xl mt-auto border border-gray-100">
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="rounded-[2.5rem] p-8 md:p-12 lg:p-16 flex flex-col lg:flex-row items-center gap-12 lg:gap-8 relative overflow-hidden shadow-soft" style="background-color: #0B2035;">
                    ...
                    <div class="w-full lg:w-1/2 relative z-10 reveal">
                        ...
                        <a href="<?php echo esc_url(home_url("/our-team/")); ?>" class="inline-flex items-center gap-2 bg-[#23bfe2] text-[#0B2035] font-bold uppercase tracking-wider text-xs px-8 py-4 rounded-md transition-all hover:bg-opacity-90 hover:shadow-md hover:-translate-y-1">
                    ...
                    <div class="w-full lg:w-1/2 relative z-10 flex justify-center items-end mt-10 lg:mt-0 reveal reveal-delay-1 h-full min-h-[400px] lg:min-h-[500px]">
                        ...
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/home/Stefani-LaFrenierre-main-home.webp" alt="Stefani LaFrenierre, MD" class="relative z-10 w-full max-w-[450px] object-contain object-bottom drop-shadow-2xl rounded-2xl lg:rounded-none lg:rounded-t-2xl lg:mt-auto">
                    </div>
                </div>
            </div>
        </section>
    ...
    <section class="py-16 bg-[#0B2035] text-white relative border-t-[8px] border-[#23bfe2]">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="space-y-4">
                ...
                <div class="bg-white/5 border border-white/10 rounded-2xl overflow-hidden reveal">
                    ...
                    <div class="px-8 pb-8 text-gray-300 font-light leading-relaxed text-lg hidden faq-content">
                        <div class="pt-2 border-t border-white/10 mt-2">
                            We specialize in a wide range of mental health conditions including <a href="<?php echo esc_url(home_url("/tms-for-depression-orange-county/")); ?>" class="text-[#23bfe2] underline hover:text-white">depression</a>, <a href="<?php echo esc_url(home_url("/tms-for-anxiety-newport-beach-ca/")); ?>" class="text-[#23bfe2] underline hover:text-white">anxiety</a>, <a href="<?php echo esc_url(home_url("/tms-for-ocd-newport-beach-ca/")); ?>" class="text-[#23bfe2] underline hover:text-white">OCD</a>, <a href="<?php echo esc_url(home_url("/tms-for-ptsd-orange-county/")); ?>" class="text-[#23bfe2] underline hover:text-white">PTSD</a>, <a href="<?php echo esc_url(home_url("/adhd-treatment-in-orange-county/")); ?>" class="text-[#23bfe2] underline hover:text-white">adult ADHD</a>, <a href="<?php echo esc_url(home_url("/tms-for-bipolar-disorder/")); ?>" class="text-[#23bfe2] underline hover:text-white">bipolar disorder</a>, <a href="<?php echo esc_url(home_url("/tms-for-substance-abuse/")); ?>" class="text-[#23bfe2] underline hover:text-white">substance use disorders</a>, and more. View our full <a href="<?php echo esc_url(home_url("/conditions/")); ?>" class="text-[#23bfe2] underline hover:text-white">conditions we treat</a> page for details.
                        </div>
                    </div>
                </div>
                <div class="bg-white/5 border border-white/10 rounded-2xl overflow-hidden reveal">
                ...
                <div class="bg-white/5 border border-white/10 rounded-2xl overflow-hidden reveal">
                    ...
                    <div class="px-8 pb-8 text-gray-300 font-light leading-relaxed text-lg hidden faq-content">
                        <div class="pt-2 border-t border-white/10 mt-2">
                            Getting started is simple. You can <a href="<?php echo esc_url(home_url("/contact/")); ?>" class="text-[#23bfe2] underline hover:text-white">schedule a consultation online</a> or call us at (949) 996-5355. You can also complete our <a href="<?php echo esc_url(home_url("/new-patient-form/")); ?>" class="text-[#23bfe2] underline hover:text-white">new patient forms</a> ahead of your first visit. Our team will conduct a comprehensive psychiatric evaluation and work with you to design a personalized treatment plan.
                        </div>
                    </div>
                </div>
            </div>
            <div class="text-center mt-12">
                <p class="text-gray-400 font-light">Have more questions? <a href="<?php echo esc_url(home_url("/contact/")); ?>" class="text-[#23bfe2] font-semibold hover:text-white transition-colors underline underline-offset-4 decoration-[#23bfe2]/30 hover:decoration-white">Contact our clinical team.</a></p>
            </div>
        </div>
    </section>
        ...
        <section class="py-20 relative overflow-hidden">
            <!-- Background Image -->
            <div class="absolute inset-0 z-0">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/home/cta-bg.png" alt="Serene Clinical Environment" class="w-full h-full object-cover object-center">
            </div>
            ...
            <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10 reveal">
                ...
                <div class="flex flex-col sm:flex-row justify-center gap-6 items-center">
                    <a href="<?php echo esc_url(home_url("/contact/")); ?>" class="group relative inline-flex items-center justify-center bg-lightblue hover:bg-[#1aadd0] text-primary font-bold px-10 py-5 rounded-full transition-all duration-300 shadow-xl hover:-translate-y-1 hover:shadow-2xl overflow-hidden text-lg w-full sm:w-auto">
                        <span class="relative z-10 flex items-center gap-2">
                            Schedule Your Consultation
                            <i data-lucide="arrow-right" class="w-5 h-5 transform group-hover:translate-x-1 transition-transform"></i>
                        </span>
                    </a>
                    <a href="<?php echo esc_url(home_url("/contact/")); ?>" class="group inline-flex items-center justify-center bg-white/5 hover:bg-white/10 border-2 border-white/20 hover:border-white/40 text-white font-semibold px-10 py-5 rounded-full transition-all duration-300 text-lg w-full sm:w-auto">
                        Contact Our Team
                    </a>
                </div>
            </div>
