<?php /* Template Name: San Juan Capistrano */ ?>
<?php get_header(); ?>
...
<main>
    ...
    <section class="relative min-h-[500px] md:h-[60vh] flex items-center justify-center overflow-hidden pt-28 pb-12 md:pt-24 md:pb-0">
        ...
        <div class="absolute inset-0 z-0 bg-[#0B2035]">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/ambience/resiliency-amb-2.webp" alt="San Juan Capistrano Location - Resiliency Mind Body Medicine" class="w-full h-full object-cover object-[50%_60%] opacity-80">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="max-w-2xl mx-auto reveal">
                <div class="bg-neutral rounded-[2rem] p-8 md:p-10 border border-gray-100 shadow-soft hover:-translate-y-2 hover:shadow-2xl transition-all duration-300 text-center">
                    ...
                    <a href="/newport-beach/" class="inline-flex items-center gap-2 text-[#23bfe2] font-bold hover:text-[#0B2035] transition-colors text-lg">
