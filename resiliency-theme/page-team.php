...
<main>
    ...
    <section class="relative min-h-[500px] md:h-[60vh] flex items-center justify-center overflow-hidden pt-28 pb-12 md:pt-24 md:pb-0">
        ...
        <div class="absolute inset-0 z-0 bg-[#0B2035]">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/hero_bg.png" alt="Meet the Resiliency Team" class="w-full h-full object-cover">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                ...
                <div class="bg-white rounded-[2rem] shadow-soft border border-gray-100 hover:-translate-y-2 hover:shadow-2xl transition-all duration-300 reveal group overflow-hidden cursor-pointer" onclick="openBioModal('stefani')">
                    <div class="h-64 overflow-hidden rounded-t-[2rem]">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/team/stefani.png" alt="Dr. Stefani LaFrenierre, MD" class="w-full h-full object-cover object-top transition-transform duration-500">
                    </div>
                    <div class="p-6">
                ...
                <div class="bg-white rounded-[2rem] shadow-soft border border-gray-100 hover:-translate-y-2 hover:shadow-2xl transition-all duration-300 reveal reveal-delay-1 group overflow-hidden cursor-pointer" onclick="openBioModal('heather')">
                    <div class="h-64 overflow-hidden rounded-t-[2rem]">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/team/heather.png" alt="Dr. Heather Wong, DMSc, MPAS, PA-C, CAQ-Psych" class="w-full h-full object-cover object-top transition-transform duration-500">
                    </div>
                    <div class="p-6">
                ...
                <div class="bg-white rounded-[2rem] shadow-soft border border-gray-100 hover:-translate-y-2 hover:shadow-2xl transition-all duration-300 reveal reveal-delay-2 group overflow-hidden cursor-pointer" onclick="openBioModal('milinda')">
                    <div class="h-64 overflow-hidden rounded-t-[2rem]">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/team/milinda.png" alt="Milinda Estrada, PA-C" class="w-full h-full object-cover object-top transition-transform duration-500">
                    </div>
                    <div class="p-6">
                ...
                <div class="bg-white rounded-[2rem] shadow-soft border border-gray-100 hover:-translate-y-2 hover:shadow-2xl transition-all duration-300 reveal reveal-delay-3 group overflow-hidden cursor-pointer" onclick="openBioModal('regina')">
                    <div class="h-64 overflow-hidden rounded-t-[2rem]">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/team/regina.png" alt="Regina Dizon, PMHNP-BC" class="w-full h-full object-cover object-top transition-transform duration-500">
                    </div>
                    <div class="p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                ...
                <div class="bg-white rounded-[2rem] shadow-soft border border-gray-100 hover:-translate-y-2 hover:shadow-2xl transition-all duration-300 reveal group overflow-hidden cursor-pointer" onclick="openBioModal('rylee_k')">
                    <div class="h-64 overflow-hidden rounded-t-[2rem]">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/team/Rylee-Kaczynski-00235-2-scaled.webp" alt="Rylee Kaczynski, Director of Operations" class="w-full h-full object-cover object-top transition-transform duration-500">
                    </div>
                    <div class="p-6">
                ...
                <div class="bg-white rounded-[2rem] shadow-soft border border-gray-100 hover:-translate-y-2 hover:shadow-2xl transition-all duration-300 reveal reveal-delay-1 group overflow-hidden">
                    <div class="h-64 overflow-hidden rounded-t-[2rem]">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/team/lauren.png" alt="Lauren Kim" class="w-full h-full object-cover object-top transition-transform duration-500">
                    </div>
                    <div class="p-6">
                ...
                <div class="bg-white rounded-[2rem] shadow-soft border border-gray-100 hover:-translate-y-2 hover:shadow-2xl transition-all duration-300 reveal reveal-delay-2 group overflow-hidden">
                    <div class="h-64 overflow-hidden rounded-t-[2rem]">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/team/jeffrey.png" alt="Jeffrey Phan" class="w-full h-full object-cover object-top transition-transform duration-500">
                    </div>
                    <div class="p-6">
                ...
                <div class="bg-white rounded-[2rem] shadow-soft border border-gray-100 hover:-translate-y-2 hover:shadow-2xl transition-all duration-300 reveal reveal-delay-3 group overflow-hidden">
                    <div class="h-64 overflow-hidden rounded-t-[2rem]">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/team/dana.png" alt="Dana Yan" class="w-full h-full object-cover object-top transition-transform duration-500">
                    </div>
                    <div class="p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mt-6">
                ...
                <div class="bg-white rounded-[2rem] shadow-soft border border-gray-100 hover:-translate-y-2 hover:shadow-2xl transition-all duration-300 reveal group overflow-hidden">
                    <div class="h-64 overflow-hidden rounded-t-[2rem]">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/team/cyrus.png" alt="Cyrus Jimenez" class="w-full h-full object-cover object-top transition-transform duration-500">
                    </div>
                    <div class="p-6">
                ...
                <div class="bg-white rounded-[2rem] shadow-soft border border-gray-100 hover:-translate-y-2 hover:shadow-2xl transition-all duration-300 reveal reveal-delay-1 group overflow-hidden">
                    <div class="h-64 overflow-hidden rounded-t-[2rem]">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/team/loren.png" alt="Loren Mendez" class="w-full h-full object-cover object-top transition-transform duration-500">
                    </div>
                    <div class="p-6">
                ...
                <div class="bg-white rounded-[2rem] shadow-soft border border-gray-100 hover:-translate-y-2 hover:shadow-2xl transition-all duration-300 reveal reveal-delay-2 group overflow-hidden">
                    <div class="h-64 overflow-hidden rounded-t-[2rem]">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/team/rylee.png" alt="Rylee Hickman" class="w-full h-full object-cover object-top transition-transform duration-500">
                    </div>
                    <div class="p-6">
                ...
                <div class="bg-white rounded-[2rem] shadow-soft border border-gray-100 hover:-translate-y-2 hover:shadow-2xl transition-all duration-300 reveal reveal-delay-3 group overflow-hidden">
                    <div class="h-64 overflow-hidden rounded-t-[2rem]">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/team/cathleen.png" alt="Cathleen Sliney" class="w-full h-full object-cover object-top transition-transform duration-500">
                    </div>
                    <div class="p-6">
...
const teamBios = {
    stefani: {
        ...
        img: '<?php echo get_template_directory_uri(); ?>/assets/images/team/stefani.png',
    ...
    heather: {
        ...
        img: '<?php echo get_template_directory_uri(); ?>/assets/images/team/heather.png',
    ...
    milinda: {
        ...
        title: 'Physician Associate',
        img: '<?php echo get_template_directory_uri(); ?>/assets/images/team/milinda.png',
    ...
    regina: {
        ...
        img: '<?php echo get_template_directory_uri(); ?>/assets/images/team/regina.png',
    ...
    rylee_k: {
        ...
        img: '<?php echo get_template_directory_uri(); ?>/assets/images/team/Rylee-Kaczynski-00235-2-scaled.webp',
