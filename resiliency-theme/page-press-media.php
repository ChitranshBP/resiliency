...
<main>
    ...
    <section class="relative min-h-[500px] md:h-[60vh] flex items-center justify-center overflow-hidden pt-28 pb-12 md:pt-24 md:pb-0">
        ...
        <div class="absolute inset-0 z-0 bg-[#0B2035]">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/hero_bg.png" alt="Press and Media" class="w-full h-full object-cover">
    ...
    <section id="press" class="py-16 bg-white relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 reveal">
                ...
                <!-- Press Card - BrainsWay Ultra Provider -->
                ...
                <!-- Press Card - Instagram Reel Medicine -->
                ...
                <!-- Press Card - Multi-Site Deep TMS -->
                <div class="bg-white border border-gray-100 rounded-[2rem] p-8 hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                    <div class="flex items-center gap-3 mb-4">
                        <div class="w-10 h-10 bg-[#23bfe2]/10 rounded-xl flex items-center justify-center text-[#23bfe2]">
                ...
                <!-- Press Card - LinkedIn Thought Leadership -->
    ...
    <section class="py-16 relative overflow-hidden bg-white">
        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10 reveal">
            ...
            <div class="flex flex-col sm:flex-row justify-center gap-6 items-center">
                <a href="/about/" class="group relative inline-flex items-center justify-center bg-[#0B2035] hover:bg-[#23bfe2] text-white hover:text-[#0B2035] font-bold px-10 py-5 rounded-full transition-all duration-300 shadow-xl hover:-translate-y-1 hover:shadow-2xl w-full sm:w-auto text-lg">
