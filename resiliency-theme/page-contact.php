...
<main>
    ...
    <section class="relative min-h-[500px] md:h-[60vh] flex items-center justify-center overflow-hidden pt-28 pb-12 md:pt-24 md:pb-0">
        ...
        <div class="absolute inset-0 z-0 bg-[#0B2035]">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/hero_bg.png" alt="Contact Resiliency Mind Body Medicine" class="w-full h-full object-cover">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="flex flex-col lg:flex-row gap-16 lg:gap-20">
                ...
                <div class="w-full lg:w-7/12 reveal reveal-delay-1">
                    <div class="bg-[#0B2035]/60 rounded-[2rem] p-8 md:p-10 border border-gray-100 shadow-soft">
                        <h3 class="text-2xl font-bold text-white mb-2">Send Us a Message</h3>
                        <p class="text-white font-light mb-8">Fill out the form below and we'll get back to you as soon as possible.</p>

                        <iframe
                            src="https://link.ketaminemedia.com/widget/form/30bwSHKGXEgkj5uKMPtq"
                            style="width:100%;height:100%;border:none;border-radius:3px"
                            id="inline-30bwSHKGXEgkj5uKMPtq"
                            ...
                            data-height="717"
                            data-layout-iframe-id="inline-30bwSHKGXEgkj5uKMPtq"
                            data-form-id="30bwSHKGXEgkj5uKMPtq"
                            title="Contact Us - Website"
                            scrolling="no"
                        >
                        </iframe>
                        <script src="https://link.ketaminemedia.com/js/form_embed.js"></script>
                    </div>
                </div>
