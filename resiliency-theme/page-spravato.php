<?php /* Template Name: Spravato Treatment */ ?>
<?php
...
<main>
    ...
    <section class="relative min-h-[500px] md:h-[60vh] flex items-center justify-center overflow-hidden pt-28 pb-12 md:pt-24 md:pb-0">
        ...
        <div class="absolute inset-0 z-0 bg-[#0B2035]">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/spravato-banner.png" alt="Spravato Treatment Consultation" class="w-full h-full object-cover object-[75%_30%] md:object-[50%_30%] ">
            ...
            <div class="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
                ...
                <div class="w-full lg:w-1/2 relative reveal reveal-delay-1">
                    <div class="relative rounded-[2.5rem] overflow-hidden shadow-2xl border border-gray-100">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/spravato-home.jpg" alt="Spravato Treatment relief" class="w-full h-[500px] object-cover object-top ">
    ...
    <section class="py-12 bg-gray-50 border-t border-gray-100">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-wrap gap-3">
                ...
                <a href="<?php echo esc_url(home_url('/accelerated-tms-orange-county/')); ?>" class="inline-flex items-center gap-2 px-5 py-2.5 rounded-full border border-[#0B2035]/15 text-[#0B2035] text-sm font-medium hover:bg-[#0B2035] hover:text-white transition-all">Accelerated TMS</a>
                ...
                <a href="<?php echo esc_url(home_url('/suicidal-ideation-support/')); ?>" class="inline-flex items-center gap-2 px-5 py-2.5 rounded-full border border-[#0B2035]/15 text-[#0B2035] text-sm font-medium hover:bg-[#0B2035] hover:text-white transition-all">Suicidal Ideation Support</a>
