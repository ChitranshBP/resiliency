...
<main>
    ...
    <section class="relative min-h-[500px] md:h-[60vh] flex items-center justify-center overflow-hidden pt-28 pb-12 md:pt-24 md:pb-0">
        ...
        <div class="absolute inset-0 z-0 bg-[#0B2035]">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/telehealth_hero.png" alt="Telehealth Appointments" class="w-full h-full object-cover object-[50%_70%]">
            ...
            <div class="flex flex-col lg:flex-row items-center gap-16 lg:gap-20">
                ...
                <div class="w-full lg:w-1/2 text-[#0B2035] reveal">
                    <div class="flex items-center gap-3 mb-4">
                        <span class="h-[2px] w-12 bg-[#23bfe2]"></span>
                        <h2 class="text-sm font-bold tracking-widest text-[#23bfe2] uppercase">Virtual Psychiatric Care</h2>
                    </div>
                    ...
                    <p class="text-gray-600 text-lg mb-8 leading-relaxed font-light">
                        Resiliency Mind + Body Medicine offers secure telehealth appointments for a range of psychiatric services. Whether you're managing an ongoing condition, starting a new treatment plan, or seeking a second opinion, our virtual visits provide the same personalized attention as our in-office appointments—without the commute.
                    </p>
                    ...
                    <div class="bg-neutral p-6 rounded-2xl mb-8 border border-gray-100">
                        <ul class="space-y-4">
                            <li class="flex items-center gap-4">
                                ...
                                <span class="text-[#0B2035] font-semibold text-base">HIPAA-compliant, secure video platform</span>
                            </li>
                            <li class="flex items-center gap-4">
                                <div class="bg-[#23bfe2]/20 p-2 rounded-lg text-[#23bfe2]">
                                    <i data-lucide="check" class="w-5 h-5"></i>
                                </div>
                                <span class="text-[#0B2035] font-semibold text-base">Available for new and existing patients</span>
                            </li>
                            <li class="flex items-center gap-4">
                                <div class="bg-[#23bfe2]/20 p-2 rounded-lg text-[#23bfe2]">
                                    <i data-lucide="check" class="w-5 h-5"></i>
                                </div>
                                <span class="text-[#0B2035] font-semibold text-base">Prescriptions sent directly to your pharmacy</span>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="w-full lg:w-1/2 relative reveal reveal-delay-1">
                    <div class="relative rounded-[2.5rem] overflow-hidden shadow-2xl border border-gray-100 ring-1 ring-[#0B2035]/5">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/telehealth_hero.png" alt="Telehealth virtual visit" class="w-full h-[550px] object-cover">
                    ...
                    <div class="absolute -bottom-8 -left-8 bg-white p-6 rounded-3xl border border-gray-100 shadow-[0_20px_40px_-10px_rgba(11,32,53,0.15)] flex items-center gap-5 group hover:-translate-y-2 transition-transform duration-500">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500 font-bold uppercase tracking-widest mt-1">HIPAA Compliant</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="bg-white/5 border border-white/10 rounded-[2rem] p-8 hover:bg-white/10 transition-colors reveal text-center">
                    ...
                    <p class="text-gray-400 font-light leading-relaxed">Comprehensive initial evaluations for new patients including diagnostic assessment and treatment planning.</p>
                </div>
                ...
                <div class="bg-white/5 border border-white/10 rounded-[2rem] p-8 hover:bg-white/10 transition-colors reveal reveal-delay-1 text-center">
                    ...
                    <p class="text-gray-400 font-light leading-relaxed">Ongoing medication reviews, adjustments, and refills for existing patients.</p>
                </div>
                ...
                <div class="bg-white/5 border border-white/10 rounded-[2rem] p-8 hover:bg-white/10 transition-colors reveal text-center">
                    ...
                    <p class="text-gray-400 font-light leading-relaxed">Regular check-ins to monitor progress, adjust treatment, and provide ongoing support.</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="max-w-4xl mx-auto reveal">
                <div class="bg-white rounded-[2rem] p-10 shadow-soft border border-gray-100">
                    <div class="flex items-start gap-5">
                        ...
                        <div>
                            <p class="text-gray-600 text-lg font-light leading-relaxed mb-4">Some services require in-person visits at our Newport Beach or San Juan Capistrano offices:</p>
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="space-y-4">
                ...
                <div class="bg-white/5 border border-white/10 rounded-2xl overflow-hidden reveal">
                    ...
                    <div class="px-8 pb-8 text-gray-300 font-light leading-relaxed text-lg hidden faq-content">
                        <div class="pt-2 border-t border-white/10 mt-2">
                            A device with a camera and microphone (smartphone, tablet, or computer), a stable internet connection, and a private, quiet location.
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white/5 border border-white/10 rounded-2xl overflow-hidden reveal">
                    ...
                    <div class="px-8 pb-8 text-gray-300 font-light leading-relaxed text-lg hidden faq-content">
                        <div class="pt-2 border-t border-white/10 mt-2">
                            Yes. Your provider can send prescriptions electronically to any pharmacy, including controlled substances when clinically appropriate.
                        </div>
                    </div>
                </div>
