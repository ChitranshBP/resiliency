<?php /* Template Name: Treatment - Deep TMS */ ?>
<?php
...
<script type="application/ld+json">
{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[{"@type":"Question","name":"Does Deep TMS Therapy hurt?","acceptedAnswer":{"@type":"Answer","text":"Deep TMS is non-invasive and well-tolerated. Most patients feel a mild tapping sensation on the scalp. Scalp discomfort or mild headaches may occur initially but typically subside after the first week."}},{"@type":"Question","name":"Can I drive after my Deep TMS session?","acceptedAnswer":{"@type":"Answer","text":"Yes. Deep TMS requires no anesthesia or sedation. You can drive to and from appointments and return to normal activities immediately afterward."}},{"@type":"Question","name":"Will my insurance cover Deep TMS?","acceptedAnswer":{"@type":"Answer","text":"Most commercial insurance carriers and Medicare cover Deep TMS for Major Depressive Disorder when medical necessity criteria are met, typically after trying 2-4 antidepressants. Our team performs full benefits verification."}},{"@type":"Question","name":"How is Deep TMS (BrainsWay) different from standard TMS?","acceptedAnswer":{"@type":"Answer","text":"BrainsWay Deep TMS uses a patented H-Coil helmet that reaches deeper and broader brain regions than traditional figure-8 coils, enabling treatment of OCD and severe depression with greater efficacy."}},{"@type":"Question","name":"How many Deep TMS sessions are needed?","acceptedAnswer":{"@type":"Answer","text":"A standard course is typically 20-36 sessions over 4-6 weeks, with sessions lasting about 20 minutes each on a daily basis (Monday through Friday)."}},{"@type":"Question","name":"Is Deep TMS safe for long-term use?","acceptedAnswer":{"@type":"Answer","text":"Yes. Deep TMS has an excellent safety profile with over 15 years of clinical data. Serious side effects are rare. Maintenance sessions may be recommended after the initial course to sustain results."}}]}
</script>
SCHEMA;
?>
<?php get_header(); ?>
...
<main>
    ...
    <section class="relative min-h-[500px] md:h-[60vh] flex items-center justify-center overflow-hidden pt-28 pb-12 md:pt-24 md:pb-0">
        ...
        <div class="absolute inset-0 z-0 bg-[#0B2035]">
            <!-- <img src="<?php echo get_template_directory_uri(); ?>/assets/images/home/TMS-Therapy-Orange-County-homepage.webp" alt="Deep TMS Therapy" class="w-full h-full object-cover opacity-30 mix-blend-overlay border-none"> -->
            <!-- Placeholder for now if image isn't right, or we can use the same image with dark overlay -->
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/anxiety_consultation.png" alt="Deep TMS Therapy Consultation" class="w-full h-full object-cover object-right md:object-[50%_30%]">
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
            <div class="max-w-3xl reveal text-left">
                ...
                <h1 class="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white tracking-tight leading-tight mb-4 sm:mb-6">
                    Deep TMS <span class="text-[#23bfe2] font-light">Therapy</span>
            ...
            <div class="flex flex-col lg:flex-row items-center gap-16 lg:gap-20">
                ...
                <div class="w-full lg:w-1/2 relative reveal reveal-delay-1">
                    <div class="relative rounded-[2.5rem] overflow-hidden shadow-2xl border border-gray-100 ring-1 ring-[#0B2035]/5">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/home/TMS-Therapy-Orange-County-homepage.webp" alt="Patient receiving Deep TMS Therapy" class="w-full h-[550px] object-cover">
                ...
                <div class="w-full lg:w-1/2 reveal reveal-delay-1">
                    <div class="relative group">
                        ...
                        <div class="relative rounded-[2.5rem] overflow-hidden shadow-2xl border border-white/10 bg-[#0B2035]/50 backdrop-blur-sm p-2 ring-1 ring-white/20">
                            <img 
                                src="<?php echo get_template_directory_uri(); ?>/assets/images/mental-Health/TMS/how-tms-works-2048x1152.webp" 
                ...
                <div class="w-full lg:w-1/2 reveal reveal-delay-1">
                    <div class="relative group">
                        ...
                        <div class="relative rounded-[3rem] overflow-hidden shadow-2xl border-4 border-white ring-1 ring-gray-100">
                            <img 
                                src="<?php echo get_template_directory_uri(); ?>/assets/images/mental-Health/TMS/Dr.-L-tms.webp" 
    ...
    <section class="py-12 bg-gray-50 border-t border-gray-100">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-wrap gap-3">
                <a href="<?php echo esc_url(home_url('/accelerated-tms-orange-county/')); ?>" class="inline-flex items-center gap-2 px-5 py-2.5 rounded-full border border-[#0B2035]/15 text-[#0B2035] text-sm font-medium hover:bg-[#0B2035] hover:text-white transition-all">Accelerated TMS (SWIFT Protocol)</a>
                ...
                <a href="<?php echo esc_url(home_url('/tms-for-anxiety-newport-beach-ca/')); ?>" class="inline-flex items-center gap-2 px-5 py-2.5 rounded-full border border-[#0B2035]/15 text-[#0B2035] text-sm font-medium hover:bg-[#0B2035] hover:text-white transition-all">Anxiety Treatment</a>
                <a href="<?php echo esc_url(home_url('/tms-for-ocd-newport-beach-ca/')); ?>" class="inline-flex items-center gap-2 px-5 py-2.5 rounded-full border border-[#0B2035]/15 text-[#0B2035] text-sm font-medium hover:bg-[#0B2035] hover:text-white transition-all">OCD Treatment</a>
