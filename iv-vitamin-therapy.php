        ...
        <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
            <div class="max-w-3xl reveal text-left">
                <div class="flex items-center gap-3 mb-6">
                    ...
                    <span class="text-[#23bfe2] text-sm font-bold tracking-widest uppercase">Restorative Wellness</span>
                </div>
                <h1 class="text-4xl md:text-5xl lg:text-7xl font-bold text-white tracking-tight leading-tight mb-6">
                    IV Vitamin <br/><span class="text-[#23bfe2] font-light">Therapy</span>
                </h1>
