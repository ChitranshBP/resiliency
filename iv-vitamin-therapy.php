...
<main>
    ...
    <section id="iv-menu" class="py-16 bg-[#0B2035] relative overflow-hidden text-white border-t border-white/10">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="text-center max-w-3xl mx-auto mb-20 reveal">
                <h2 class="text-sm font-bold tracking-widest text-[#23bfe2] uppercase mb-4">Our IV Menu</h2>
                <h3 class="text-4xl md:text-5xl font-bold text-white mb-6">Restorative IV Drip Formulas</h3>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <!-- Card 1 - Myers' Cocktail -->
                <div class="bg-white/5 border border-white/10 rounded-[2rem] p-10 hover:bg-white/10 transition-all duration-300 reveal group flex flex-col items-center text-center">
                    ...
                    <h4 class="text-2xl font-bold text-white mb-4">Myers' Cocktail</h4>
                    <p class="text-gray-400 font-light leading-relaxed">Our signature blend of calcium, magnesium, vitamin C, and B-complex vitamins. The gold standard for overall wellness, energy, and immune support.</p>
                </div>

                <!-- Card 2 - Immune Boost IV -->
                <div class="bg-white/5 border border-white/10 rounded-[2rem] p-10 hover:bg-white/10 transition-all duration-300 reveal reveal-delay-1 group flex flex-col items-center text-center">
                    ...
                    <h4 class="text-2xl font-bold text-white mb-4">Immune Boost IV</h4>
                    <p class="text-gray-400 font-light leading-relaxed">High-dose vitamin C, zinc, and immune-supporting nutrients to strengthen your body's natural defenses—especially during cold and flu season.</p>
                </div>
                ...
                <div class="bg-white/5 border border-white/10 rounded-[2rem] p-10 hover:bg-white/10 transition-all duration-300 reveal group flex flex-col items-center text-center">
                    ...
                    <h4 class="text-2xl font-bold text-white mb-4">Radiance IV</h4>
                    <p class="text-gray-400 font-light leading-relaxed">A beauty-focused formula with glutathione, biotin, and antioxidants to promote glowing skin, healthy hair, and a youthful complexion.</p>
                </div>
    ...
    <!-- Vitamin Booster Shots Section -->
    <section class="py-16 bg-white relative overflow-hidden">
        <div class="absolute -top-32 -right-32 w-96 h-96 bg-[#23bfe2]/10 rounded-full blur-[100px] pointer-events-none"></div>

        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center max-w-3xl mx-auto mb-20 reveal">
                <h2 class="text-sm font-bold tracking-widest text-[#23bfe2] uppercase mb-4">Quick Boosters</h2>
                <h3 class="text-4xl md:text-5xl font-bold text-primary mb-6">Vitamin Booster Shots</h3>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="bg-neutral rounded-[2rem] p-8 shadow-soft border border-gray-100 hover:-translate-y-2 hover:shadow-2xl transition-all duration-300 reveal reveal-delay-2 group text-center">
                    ...
                    <h4 class="text-lg font-bold text-primary mb-2">Glutathione</h4>
                    <p class="text-gray-500 font-light text-sm leading-relaxed">A powerful antioxidant peptide that helps slow aging and boost immune system function.</p>
                </div>
            </div>
        </div>
    </section>
