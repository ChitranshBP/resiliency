...
<main>
    ...
    <section class="relative h-[60vh] min-h-[500px] flex items-center justify-center overflow-hidden pt-24">
        <div class="absolute inset-0 z-0 bg-[#0B2035]">
            <img src="assets/images/med_tech_bg.png" alt="OCD Treatment" class="w-full h-full object-cover">
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
            <div class="max-w-3xl reveal text-left">
                ...
                <h1 class="text-4xl md:text-5xl lg:text-7xl font-bold text-white tracking-tight leading-tight mb-6">
                    OCD <br/><span class="text-[#23bfe2] font-light">Treatment</span>
                </h1>
                <p class="text-lg md:text-xl text-gray-200 mb-10 leading-relaxed font-light max-w-2xl">
                    Advanced treatment for obsessive-compulsive disorder using FDA-cleared Deep TMS therapy, targeted medication management, and evidence-based behavioral strategies.
                </p>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="flex flex-col lg:flex-row items-center gap-16 lg:gap-20">
                <div class="w-full lg:w-1/2 text-[#0B2035] reveal">
                    ...
                    <h3 class="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">Breaking the Cycle of OCD</h3>
                    <p class="text-gray-600 text-lg mb-6 leading-relaxed font-light">
                        OCD involves persistent unwanted thoughts (obsessions) and repetitive behaviors (compulsions) that can significantly impair daily functioning and quality of life.
                    </p>
                    <p class="text-gray-600 text-lg mb-8 leading-relaxed font-light">
                        Deep TMS is FDA-cleared specifically for OCD, targeting deeper brain structures that traditional treatments cannot reach. Combined with ERP therapy and conservative medication, our patients achieve significant symptom reduction.
                    </p>
                </div>
                ...
                <div class="w-full lg:w-1/2 relative reveal reveal-delay-1">
                    <div class="relative rounded-[2.5rem] overflow-hidden shadow-2xl border border-gray-100 ring-1 ring-[#0B2035]/5">
                        <img src="assets/images/med_tech_bg.png" alt="OCD Treatment at Resiliency" class="w-full h-[450px] object-cover">
    ...
    <section class="py-16 bg-[#0B2035] relative overflow-hidden text-white border-t border-white/10">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="text-center max-w-3xl mx-auto mb-16 reveal">
                ...
                <h3 class="text-4xl md:text-5xl font-bold">How We Treat OCD</h3>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div class="bg-white/5 border border-white/10 rounded-[2rem] p-8 hover:-translate-y-2 transition-all duration-300 reveal group">
                    ...
                    <h4 class="text-xl font-bold mb-3">Deep TMS for OCD</h4>
                    <p class="text-gray-300 font-light leading-relaxed">FDA-cleared, targets deeper brain regions with BrainsWay H-Coil technology.</p>
                </div>
                ...
                <div class="bg-white/5 border border-white/10 rounded-[2rem] p-8 hover:-translate-y-2 transition-all duration-300 reveal reveal-delay-1 group">
                    ...
                    <h4 class="text-xl font-bold mb-3">Targeted Medication</h4>
                    <p class="text-gray-300 font-light leading-relaxed">SRI medications optimized for OCD at appropriate therapeutic doses.</p>
                </div>
                ...
                <div class="bg-white/5 border border-white/10 rounded-[2rem] p-8 hover:-translate-y-2 transition-all duration-300 reveal reveal-delay-2 group">
                    ...
                    <h4 class="text-xl font-bold mb-3">ERP Therapy</h4>
                    <p class="text-gray-300 font-light leading-relaxed">Exposure and response prevention therapy referrals for behavioral change.</p>
                </div>
                ...
                <div class="bg-white/5 border border-white/10 rounded-[2rem] p-8 hover:-translate-y-2 transition-all duration-300 reveal reveal-delay-3 group">
                    ...
                    <h4 class="text-xl font-bold mb-3">Combined Approach</h4>
                    <p class="text-gray-300 font-light leading-relaxed">Multimodal treatment for maximum effectiveness and lasting results.</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="space-y-4">
                <div class="bg-white/5 border border-white/10 rounded-2xl overflow-hidden reveal">
                    <button class="faq-toggle w-full px-8 py-6 text-left font-bold text-xl flex items-center justify-between focus:outline-none hover:bg-white/5 transition-colors group">
                        <span>Is TMS FDA-cleared for OCD?</span>
                    ...
                    <div class="px-8 pb-8 text-gray-300 font-light leading-relaxed text-lg hidden faq-content">
                        <div class="pt-2 border-t border-white/10 mt-2">
                            Yes. BrainsWay Deep TMS received FDA clearance for OCD treatment, making it one of the few non-medication options with proven efficacy.
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white/5 border border-white/10 rounded-2xl overflow-hidden reveal">
                    <button class="faq-toggle w-full px-8 py-6 text-left font-bold text-xl flex items-center justify-between focus:outline-none hover:bg-white/5 transition-colors group">
                        <span>How effective is TMS for OCD?</span>
                        <div class="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-[#23bfe2] group-hover:bg-[#23bfe2] group-hover:text-[#0B2035] transition-colors">
                            <i data-lucide="plus" class="w-5 h-5 transition-transform duration-300"></i>
                        </div>
                    </button>
                    <div class="px-8 pb-8 text-gray-300 font-light leading-relaxed text-lg hidden faq-content">
                        <div class="pt-2 border-t border-white/10 mt-2">
                            Clinical studies demonstrate significant symptom reduction. Our clinic utilizes the H7 coil specifically designed for OCD protocols.
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white/5 border border-white/10 rounded-2xl overflow-hidden reveal">
                    <button class="faq-toggle w-full px-8 py-6 text-left font-bold text-xl flex items-center justify-between focus:outline-none hover:bg-white/5 transition-colors group">
                        <span>Can OCD be treated without medication?</span>
                        <div class="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-[#23bfe2] group-hover:bg-[#23bfe2] group-hover:text-[#0B2035] transition-colors">
                            <i data-lucide="plus" class="w-5 h-5 transition-transform duration-300"></i>
                        </div>
                    </button>
                    <div class="px-8 pb-8 text-gray-300 font-light leading-relaxed text-lg hidden faq-content">
                        <div class="pt-2 border-t border-white/10 mt-2">
                            TMS offers a powerful non-medication option. Many patients achieve meaningful improvement through TMS combined with ERP therapy.
                        </div>
                    </div>
                </div>
            </div>
