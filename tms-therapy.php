        ...
        <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
            <div class="max-w-3xl reveal text-left">
                <div class="flex items-center gap-3 mb-6">
                    ...
                    <span class="text-[#23bfe2] text-sm font-bold tracking-widest uppercase">Non-Invasive Neuromodulation</span>
                </div>
                <h1 class="text-4xl md:text-5xl lg:text-7xl font-bold text-white tracking-tight leading-tight mb-6">
                    Deep TMS <br/><span class="text-[#23bfe2] font-light">Therapy</span>
                </h1>
            ...
            <div class="columns-1 md:columns-2 lg:columns-3 gap-6 space-y-6">
                ...
                <div class="break-inside-avoid bg-white border border-gray-100 p-8 rounded-[2rem] shadow-sm hover:shadow-xl transition-all duration-300 group">
                    ...
                    <p class="text-gray-700 text-base leading-relaxed mb-8 font-light italic">
                        "After struggling with depression for years and trying multiple medications, Deep TMS finally gave me my life back. The staff at Resiliency is so compassionate, I felt safe and supported throughout the entire journey."
                    </p>
                    <div class="flex items-center justify-between border-t border-gray-50 pt-6">
                        <div class="flex items-center gap-3">
                            <div class="w-10 h-10 rounded-full bg-pink-100 text-[#0B2035] flex items-center justify-center font-bold text-sm">MT</div>
                            <span class="font-bold text-gray-800">Michael T.</span>
                        </div>
                ...
                <div class="break-inside-avoid bg-white border border-gray-100 p-8 rounded-[2rem] shadow-sm hover:shadow-xl transition-all duration-300 group">
                    ...
                    <div class="flex items-center justify-between border-t border-gray-50 pt-6">
                        <div class="flex items-center gap-3">
                            <div class="w-10 h-10 rounded-full bg-[#23bfe2]/10 text-[#23bfe2] flex items-center justify-center font-bold text-sm">SL</div>
                            <span class="font-bold text-gray-800">Sarah L.</span>
                        </div>
                        <div class="flex items-center gap-2 text-xs text-gray-400">
                            <img src="https://upload.wikimedia.org/wikipedia/commons/2/2f/Google_2015_logo.svg" alt="Google" class="h-3">
                            Google Review
                ...
                <div class="break-inside-avoid bg-white border border-gray-100 p-8 rounded-[2rem] shadow-sm hover:shadow-xl transition-all duration-300 group">
                    ...
                    <p class="text-gray-700 text-base leading-relaxed mb-8 font-light italic">
                        "I was hesitant about brain stimulation at first, but the non-invasive nature and lack of side effects convinced me. Best decision I've made. I'm finally feeling like myself again."
                    </p>
                    <div class="flex items-center justify-between border-t border-gray-50 pt-6">
                        <div class="flex items-center gap-3">
                            <div class="w-10 h-10 rounded-full bg-indigo-100 text-[#0B2035] flex items-center justify-center font-bold text-sm">DR</div>
                            <span class="font-bold text-gray-800">David R.</span>
                        </div>
                        <div class="flex items-center gap-2 text-xs text-gray-400">
                            <img src="https://upload.wikimedia.org/wikipedia/commons/2/2f/Google_2015_logo.svg" alt="Google" class="h-3">
                            Google Review
