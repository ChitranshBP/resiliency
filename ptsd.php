...
<main>
    ...
    <section class="relative h-[60vh] min-h-[500px] flex items-center justify-center overflow-hidden pt-24">
        <div class="absolute inset-0 z-0 bg-[#0B2035]">
            <img src="assets/images/ptsd_hero.png" alt="PTSD Treatment Peace" class="w-full h-full object-cover">
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
            <div class="max-w-3xl reveal text-left">
                ...
                <h1 class="text-4xl md:text-5xl lg:text-7xl font-bold text-white tracking-tight leading-tight mb-6">
                    TMS for PTSD <br/><span class="text-[#23bfe2] font-light">Treatment</span>
                </h1>
                <p class="text-lg md:text-xl text-gray-200 mb-10 leading-relaxed font-light max-w-2xl">
                    Find peace and healing with FDA-approved TMS therapy, medication management, and integrative care at Resiliency Mind+Body Medicine.
                </p>
                ...
                <div class="w-full lg:w-1/2 relative reveal reveal-delay-1 flex justify-center">
                    <div class="rounded-[2.5rem] overflow-hidden shadow-2xl border border-gray-100 ring-1 ring-[#0B2035]/5 w-[320px] h-[568px]">
                        <iframe
                            ...
                            title="TMS for PTSD Treatment at Resiliency Mind+Body Medicine"
                            frameborder="0"
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="flex flex-col lg:flex-row items-center gap-16 lg:gap-20">
                ...
                <div class="w-full lg:w-1/2 relative reveal flex justify-center">
                    <div class="rounded-[2.5rem] overflow-hidden shadow-2xl border border-gray-100 ring-1 ring-[#0B2035]/5 w-[320px] h-[568px]">
                        <iframe
                            ...
                            title="TMS for PTSD at Resiliency Mind+Body Medicine"
                            frameborder="0"
                            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                            allowfullscreen
                            class="w-full h-full"
                ...
                <div class="w-full lg:w-1/2 text-[#0B2035] reveal reveal-delay-1">
                    <div class="flex items-center gap-3 mb-4">
                        <span class="h-[2px] w-12 bg-[#23bfe2]"></span>
                        <h2 class="text-sm font-bold tracking-widest text-[#23bfe2] uppercase">TMS & PTSD</h2>
                    </div>
                    <h3 class="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">Can TMS Help With PTSD?</h3>
                    <p class="text-gray-600 text-lg mb-6 leading-relaxed font-light">
                        Transcranial Magnetic Stimulation (TMS) is a non-invasive neuromodulation treatment that uses magnetic pulses to influence brain circuits involved in mood regulation, fear processing, and emotional control. While TMS is FDA-cleared for major depressive disorder, clinical evidence supports its use in carefully selected patients with PTSD, particularly when symptoms persist despite psychotherapy and medication trials.
                    </p>
                    <p class="text-gray-600 text-lg leading-relaxed font-light">
                        At Resiliency, TMS for PTSD is offered under close psychiatric supervision and integrated into a personalized care plan to support safety and effectiveness.
                    </p>
                </div>
            </div>
        </div>
    ...
    <section class="py-16 bg-[#0B2035] relative overflow-hidden text-white border-t border-white/10">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="text-center max-w-3xl mx-auto mb-16 reveal">
                ...
                <h3 class="text-4xl md:text-5xl font-bold mb-6">How TMS Works for PTSD</h3>
                <p class="text-gray-300 text-lg font-light leading-relaxed">
                    Transcranial magnetic stimulation (TMS) targets specific brain areas involved in mood regulation and stress response. By delivering magnetic pulses to these regions, TMS can help modulate brain activity, reducing symptoms of PTSD and improving overall mental health.
                </p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="bg-white/5 border border-white/10 rounded-[2rem] p-10 hover:-translate-y-2 transition-all duration-300 reveal reveal-delay-1 group text-center">
                    ...
                    <p class="text-gray-400 font-light leading-relaxed">TMS does not require medication, avoiding potential side effects of pharmaceuticals.</p>
                </div>
                ...
                <div class="bg-white/5 border border-white/10 rounded-[2rem] p-10 hover:-translate-y-2 transition-all duration-300 reveal reveal-delay-2 group text-center">
                    ...
                    <p class="text-gray-400 font-light leading-relaxed">TMS can help restore normal functioning, allowing patients to engage in everyday activities without the constant burden of PTSD symptoms.</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <div class="relative reveal group">
                    <div class="bg-neutral rounded-[2rem] p-10 border border-gray-100 hover:shadow-xl transition-all duration-300 h-full">
                        ...
                        <p class="text-gray-500 font-light leading-relaxed">
                            Our team assesses your medical history, current symptoms, and treatment goals to determine if TMS is the right choice for you. This personalized consultation ensures a tailored approach.
                        </p>
                    </div>
                ...
                <div class="relative reveal reveal-delay-1 group">
                    <div class="bg-neutral rounded-[2rem] p-10 border border-gray-100 hover:shadow-xl transition-all duration-300 h-full">
                        ...
                        <p class="text-gray-500 font-light leading-relaxed">
                            TMS sessions typically last about 10 minutes and are conducted five days a week for several weeks. You sit comfortably while magnetic pulses are delivered—no anesthesia needed, resume activities immediately.
                        </p>
                    </div>
                    <div class="hidden lg:block absolute top-1/2 -right-4 text-[#23bfe2]/30">
                        <i data-lucide="chevron-right" class="w-8 h-8"></i>
            ...
            <div class="space-y-4">
                <div class="bg-white/5 border border-white/10 rounded-2xl overflow-hidden reveal">
                    <button class="faq-toggle w-full px-8 py-6 text-left font-bold text-xl flex items-center justify-between focus:outline-none hover:bg-white/5 transition-colors group">
                        <span>What is TMS for PTSD and how does it work?</span>
                    ...
                    <div class="px-8 pb-8 text-gray-300 font-light leading-relaxed text-lg hidden faq-content">
                        <div class="pt-2 border-t border-white/10 mt-2">
                            TMS (Transcranial Magnetic Stimulation) for PTSD uses magnetic pulses to stimulate neural pathways involved in trauma, fear processing, and stress regulation. By activating under-functioning brain regions, TMS helps reduce symptoms like intrusive memories, hypervigilance, and avoidance. It's non-invasive and typically done without anesthesia.
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white/5 border border-white/10 rounded-2xl overflow-hidden reveal">
                    <button class="faq-toggle w-full px-8 py-6 text-left font-bold text-xl flex items-center justify-between focus:outline-none hover:bg-white/5 transition-colors group">
                        <span>How will I know if TMS for PTSD is working, and is follow-up required?</span>
                        <div class="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-[#23bfe2] group-hover:bg-[#23bfe2] group-hover:text-[#0B2035] transition-colors">
                            <i data-lucide="plus" class="w-5 h-5 transition-transform duration-300"></i>
                        </div>
                    </button>
                ...
                <div class="bg-white/5 border border-white/10 rounded-2xl overflow-hidden reveal">
                    <button class="faq-toggle w-full px-8 py-6 text-left font-bold text-xl flex items-center justify-between focus:outline-none hover:bg-white/5 transition-colors group">
                        <span>What are the possible side effects for TMS when treating PTSD?</span>
                        <div class="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-[#23bfe2] group-hover:bg-[#23bfe2] group-hover:text-[#0B2035] transition-colors">
                            <i data-lucide="plus" class="w-5 h-5 transition-transform duration-300"></i>
                        </div>
                    </button>
                ...
                <div class="bg-white/5 border border-white/10 rounded-2xl overflow-hidden reveal">
                    <button class="faq-toggle w-full px-8 py-6 text-left font-bold text-xl flex items-center justify-between focus:outline-none hover:bg-white/5 transition-colors group">
                        <span>How long is a course of TMS for PTSD, and what does a typical session look like?</span>
                        <div class="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-[#23bfe2] group-hover:bg-[#23bfe2] group-hover:text-[#0B2035] transition-colors">
                            <i data-lucide="plus" class="w-5 h-5 transition-transform duration-300"></i>
                        </div>
                    </button>
