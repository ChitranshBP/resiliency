...
<main>
    ...
    <section class="relative h-[60vh] min-h-[500px] flex items-center justify-center overflow-hidden pt-24">
        <div class="absolute inset-0 z-0 bg-[#0B2035]">
            <img src="assets/images/med_tech_bg.png" alt="PTSD Treatment" class="w-full h-full object-cover">
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
            <div class="max-w-3xl reveal text-left">
                ...
                <h1 class="text-4xl md:text-5xl lg:text-7xl font-bold text-white tracking-tight leading-tight mb-6">
                    PTSD <br/><span class="text-[#23bfe2] font-light">Treatment</span>
                </h1>
                <p class="text-lg md:text-xl text-gray-200 mb-10 leading-relaxed font-light max-w-2xl">
                    Trauma-informed treatment for post-traumatic stress disorder combining Deep TMS neuromodulation, conservative medication management, and integrative healing approaches.
                </p>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="flex flex-col lg:flex-row items-center gap-16 lg:gap-20">
                <div class="w-full lg:w-1/2 text-[#0B2035] reveal">
                    ...
                    <h3 class="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">Healing from Trauma</h3>
                    <p class="text-gray-600 text-lg mb-6 leading-relaxed font-light">
                        PTSD develops after experiencing or witnessing traumatic events, causing flashbacks, nightmares, hypervigilance, and emotional numbing that can profoundly impact daily life.
                    </p>
                    <p class="text-gray-600 text-lg mb-8 leading-relaxed font-light">
                        Our trauma-informed approach uses Deep TMS to modulate brain circuits disrupted by trauma, alongside carefully managed medication and referrals to specialized trauma therapies like EMDR and CPT.
                    </p>
                </div>
                ...
                <div class="w-full lg:w-1/2 relative reveal reveal-delay-1">
                    <div class="relative rounded-[2.5rem] overflow-hidden shadow-2xl border border-gray-100 ring-1 ring-[#0B2035]/5">
                        <img src="assets/images/med_tech_bg.png" alt="PTSD Treatment at Resiliency" class="w-full h-[450px] object-cover">
    ...
    <section class="py-16 bg-[#0B2035] relative overflow-hidden text-white border-t border-white/10">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="text-center max-w-3xl mx-auto mb-16 reveal">
                ...
                <h3 class="text-4xl md:text-5xl font-bold">How We Treat PTSD</h3>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div class="bg-white/5 border border-white/10 rounded-[2rem] p-8 hover:-translate-y-2 transition-all duration-300 reveal group">
                    ...
                    <h4 class="text-xl font-bold mb-3">Deep TMS for PTSD</h4>
                    <p class="text-gray-300 font-light leading-relaxed">Targets trauma-disrupted brain circuits for symptom relief.</p>
                </div>
                ...
                <div class="bg-white/5 border border-white/10 rounded-[2rem] p-8 hover:-translate-y-2 transition-all duration-300 reveal reveal-delay-1 group">
                    ...
                    <p class="text-gray-300 font-light leading-relaxed">Careful, trauma-informed prescribing with a conservative approach.</p>
                </div>
                ...
                <div class="bg-white/5 border border-white/10 rounded-[2rem] p-8 hover:-translate-y-2 transition-all duration-300 reveal reveal-delay-2 group">
                    ...
                    <h4 class="text-xl font-bold mb-3">Trauma Therapies</h4>
                    <p class="text-gray-300 font-light leading-relaxed">Referrals for EMDR, CPT, and prolonged exposure therapy.</p>
                </div>
                ...
                <div class="bg-white/5 border border-white/10 rounded-[2rem] p-8 hover:-translate-y-2 transition-all duration-300 reveal reveal-delay-3 group">
                    ...
                    <h4 class="text-xl font-bold mb-3">Holistic Support</h4>
                    <p class="text-gray-300 font-light leading-relaxed">Mindfulness, lifestyle interventions, and integrative wellness.</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="space-y-4">
                <div class="bg-white/5 border border-white/10 rounded-2xl overflow-hidden reveal">
                    <button class="faq-toggle w-full px-8 py-6 text-left font-bold text-xl flex items-center justify-between focus:outline-none hover:bg-white/5 transition-colors group">
                        <span>How does TMS help PTSD?</span>
                    ...
                    <div class="px-8 pb-8 text-gray-300 font-light leading-relaxed text-lg hidden faq-content">
                        <div class="pt-2 border-t border-white/10 mt-2">
                            Deep TMS modulates neural circuits disrupted by trauma, helping to reduce hyperarousal, intrusive thoughts, and emotional dysregulation. Many patients experience significant improvement.
                        </div>
                    </div>
                </div>
