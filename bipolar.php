...
<main>
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
            <div class="max-w-3xl reveal text-left">
                ...
                <h1 class="text-4xl md:text-5xl lg:text-7xl font-bold text-white tracking-tight leading-tight mb-6">
                    TMS for Bipolar<br/><span class="text-[#23bfe2] font-light">Disorder Treatment</span>
                </h1>
                <p class="text-lg md:text-xl text-gray-200 mb-10 leading-relaxed font-light max-w-2xl">
                    Achieve mood stability with a multi-modality approach including FDA-approved TMS therapy, medication management, and integrative care at Resiliency Mind+Body Medicine.
                </p>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="flex flex-col lg:flex-row items-center gap-16 lg:gap-20">
                <div class="w-full lg:w-1/2 text-[#0B2035] reveal">
                    ...
                    <p class="text-gray-600 text-lg mb-6 leading-relaxed font-light">
                        Managing bipolar disorder often requires a combination of medication and psychotherapy. However, some individuals do not respond adequately to these treatments, where TMS offers a promising alternative.
                    </p>
                ...
                <div class="w-full lg:w-1/2 relative reveal reveal-delay-1">
                    <div class="relative rounded-[2.5rem] overflow-hidden shadow-2xl border border-gray-100 ring-1 ring-[#0B2035]/5">
                        <img src="assets/images/bipolar_understanding.png" alt="Understanding Bipolar Disorder" class="w-full h-[450px] object-cover">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="flex flex-col lg:flex-row items-center gap-16 lg:gap-20">
                ...
                <div class="w-full lg:w-1/2 relative reveal">
                    <div class="relative rounded-[2.5rem] overflow-hidden shadow-2xl border border-gray-100 ring-1 ring-[#0B2035]/5">
                        <img src="assets/images/bipolar_relief.png" alt="TMS for Bipolar Disorder" class="w-full h-[500px] object-cover">
                        <div class="absolute inset-0 bg-gradient-to-tr from-[#0B2035]/20 via-transparent to-transparent"></div>
                    </div>
                    ...
                    <div class="absolute -bottom-6 -right-6 bg-white p-5 rounded-3xl border border-gray-100 shadow-[0_20px_40px_-10px_rgba(11,32,53,0.15)] flex items-center gap-4 group hover:-translate-y-2 transition-transform duration-500">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500 font-bold uppercase tracking-widest mt-1">TMS Technology</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="w-full lg:w-1/2 text-[#0B2035] reveal reveal-delay-1">
                    <div class="flex items-center gap-3 mb-4">
                        <span class="h-[2px] w-12 bg-[#23bfe2]"></span>
                        <h2 class="text-sm font-bold tracking-widest text-[#23bfe2] uppercase">TMS & Bipolar</h2>
                    </div>
                    <h3 class="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">Can TMS Help With Bipolar Disorder?</h3>
                    <p class="text-gray-600 text-lg mb-6 leading-relaxed font-light">
                        Transcranial Magnetic Stimulation (TMS) is a non-invasive neuromodulation treatment that uses magnetic pulses to stimulate specific areas of the brain involved in mood regulation. While TMS is FDA-cleared for major depressive disorder, growing clinical evidence supports its use in carefully selected patients with bipolar depression under close psychiatric supervision.
                    </p>
                    <p class="text-gray-600 text-lg leading-relaxed font-light">
                        At Resiliency, TMS for bipolar disorder is never offered in isolation. Our physicians conduct a thorough evaluation to confirm diagnosis, rule out contraindications, and ensure treatment is integrated into a comprehensive plan designed to minimize the risk of mood switching or destabilization.
                    </p>
                </div>
            </div>
        </div>
    ...
    <section class="py-16 bg-[#0B2035] relative overflow-hidden text-white border-t border-white/10">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="text-center max-w-3xl mx-auto mb-16 reveal">
                ...
                <p class="text-gray-300 text-lg font-light leading-relaxed">TMS works best when it is part of a broader, personalized treatment strategy. At Resiliency, bipolar disorder care may include:</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white/5 border border-white/10 rounded-[2rem] p-8 hover:-translate-y-2 transition-all duration-300 reveal group">
                    ...
                    <p class="text-gray-300 font-light leading-relaxed">BrainsWay® Deep TMS targets deeper and broader brain networks involved in mood regulation. For patients with bipolar depression who haven't achieved sufficient relief from medications alone, TMS can improve depressive symptoms, motivation, and overall functioning under physician oversight.</p>
                </div>
    ...
    <section class="py-16 bg-white relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="text-center max-w-3xl mx-auto mb-16 reveal">
                ...
                <h3 class="text-4xl md:text-5xl font-bold text-[#0B2035] mb-6">How TMS Works for Bipolar Disorder</h3>
                <p class="text-gray-600 text-lg leading-relaxed font-light">
                    Transcranial magnetic stimulation (TMS) targets the brain's dorsolateral prefrontal cortex, a region involved in mood regulation. By delivering magnetic pulses, TMS stimulates neural activity in this area, which can help stabilize mood swings and reduce the severity of both manic and depressive episodes.
                </p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="bg-neutral rounded-[2rem] p-10 shadow-soft border border-gray-100 hover:-translate-y-2 hover:shadow-2xl transition-all duration-300 reveal group text-center">
                    ...
                    <p class="text-gray-500 font-light leading-relaxed">TMS helps balance brain activity, leading to more stable moods and fewer extreme highs and lows.</p>
                </div>
                ...
                <div class="bg-neutral rounded-[2rem] p-10 shadow-soft border border-gray-100 hover:-translate-y-2 hover:shadow-2xl transition-all duration-300 reveal reveal-delay-1 group text-center">
                    ...
                    <p class="text-gray-500 font-light leading-relaxed">TMS does not involve surgery or medication, reducing the risk of side effects associated with pharmacological treatments.</p>
                </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="relative reveal group">
                    <div class="bg-white rounded-[2rem] p-10 border border-gray-100 hover:shadow-xl transition-all duration-300 h-full">
                        ...
                        <p class="text-gray-500 font-light leading-relaxed">
                            The journey to mood stability begins with a comprehensive evaluation to determine if TMS is suitable for your bipolar disorder. Our team will understand your medical history, current symptoms, and treatment goals.
                        </p>
                    </div>
                ...
                <div class="relative reveal reveal-delay-1 group">
                    <div class="bg-white rounded-[2rem] p-10 border border-gray-100 hover:shadow-xl transition-all duration-300 h-full">
                        ...
                        <p class="text-gray-500 font-light leading-relaxed">
                            TMS sessions typically last 10 minutes and are conducted five days a week for several weeks. You'll sit comfortably while the device delivers magnetic pulses—no anesthesia needed, and you can resume normal activities immediately.
                        </p>
                    </div>
                    <div class="hidden lg:block absolute top-1/2 -right-4 text-[#23bfe2]/30">
                        <i data-lucide="chevron-right" class="w-8 h-8"></i>
            ...
            <div class="space-y-4">
                <div class="bg-white/5 border border-white/10 rounded-2xl overflow-hidden reveal">
                    <button class="faq-toggle w-full px-8 py-6 text-left font-bold text-xl flex items-center justify-between focus:outline-none hover:bg-white/5 transition-colors group">
                        <span>Can TMS help with bipolar depression?</span>
                    ...
                    <div class="px-8 pb-8 text-gray-300 font-light leading-relaxed text-lg hidden faq-content">
                        <div class="pt-2 border-t border-white/10 mt-2">
                            Yes. TMS can be effective for the depressive phase of bipolar disorder under careful psychiatric supervision to monitor for mood switching.
                        </div>
                    </div>
                </div>
    ...
    <section class="py-16 relative overflow-hidden bg-white">
        <div class="absolute inset-0 z-0">
            <img src="assets/images/bipolar_relief.png" alt="Path to Stability" class="w-full h-full object-cover opacity-10">
