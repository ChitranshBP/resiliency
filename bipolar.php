...
<main>
    ...
    <section class="relative h-[60vh] min-h-[500px] flex items-center justify-center overflow-hidden pt-24">
        <div class="absolute inset-0 z-0 bg-[#0B2035]">
            <img src="assets/images/med_tech_bg.png" alt="Bipolar Disorder Treatment" class="w-full h-full object-cover">
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
            <div class="max-w-3xl reveal text-left">
                ...
                <h1 class="text-4xl md:text-5xl lg:text-7xl font-bold text-white tracking-tight leading-tight mb-6">
                    Bipolar <br/><span class="text-[#23bfe2] font-light">Disorder Treatment</span>
                </h1>
                <p class="text-lg md:text-xl text-gray-200 mb-10 leading-relaxed font-light max-w-2xl">
                    Expert mood stabilization and long-term management of bipolar disorder through careful medication optimization, advanced neuromodulation, and integrative lifestyle strategies.
                </p>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="flex flex-col lg:flex-row items-center gap-16 lg:gap-20">
                <div class="w-full lg:w-1/2 text-[#0B2035] reveal">
                    ...
                    <h3 class="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">Achieving Mood Stability</h3>
                    <p class="text-gray-600 text-lg mb-6 leading-relaxed font-light">
                        Bipolar disorder involves episodes of mania and depression that significantly impact daily functioning. Effective treatment requires careful mood stabilization, ongoing monitoring, and a comprehensive approach.
                    </p>
                    <p class="text-gray-600 text-lg mb-8 leading-relaxed font-light">
                        Our team provides expert medication management, with access to TMS and other advanced therapies for the depressive phases, helping you achieve lasting stability.
                    </p>
                </div>
                ...
                <div class="w-full lg:w-1/2 relative reveal reveal-delay-1">
                    <div class="relative rounded-[2.5rem] overflow-hidden shadow-2xl border border-gray-100 ring-1 ring-[#0B2035]/5">
                        <img src="assets/images/med_tech_bg.png" alt="Bipolar Disorder Treatment at Resiliency" class="w-full h-[450px] object-cover">
    ...
    <section class="py-16 bg-[#0B2035] relative overflow-hidden text-white border-t border-white/10">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="text-center max-w-3xl mx-auto mb-16 reveal">
                ...
                <h3 class="text-4xl md:text-5xl font-bold">How We Treat Bipolar Disorder</h3>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div class="bg-white/5 border border-white/10 rounded-[2rem] p-8 hover:-translate-y-2 transition-all duration-300 reveal group">
                    ...
                    <h4 class="text-xl font-bold mb-3">Mood Stabilization</h4>
                    <p class="text-gray-300 font-light leading-relaxed">Expert pharmacotherapy with mood stabilizers and atypical antipsychotics.</p>
                </div>
                ...
                <div class="bg-white/5 border border-white/10 rounded-[2rem] p-8 hover:-translate-y-2 transition-all duration-300 reveal reveal-delay-1 group">
                    ...
                    <h4 class="text-xl font-bold mb-3">TMS for Bipolar Depression</h4>
                    <p class="text-gray-300 font-light leading-relaxed">Deep TMS targeting depressive episodes while carefully monitoring mood.</p>
                </div>
                ...
                <div class="bg-white/5 border border-white/10 rounded-[2rem] p-8 hover:-translate-y-2 transition-all duration-300 reveal reveal-delay-2 group">
                    ...
                    <h4 class="text-xl font-bold mb-3">Monitoring & Prevention</h4>
                    <p class="text-gray-300 font-light leading-relaxed">Regular assessments with mood tracking and early intervention.</p>
                </div>
                ...
                <div class="bg-white/5 border border-white/10 rounded-[2rem] p-8 hover:-translate-y-2 transition-all duration-300 reveal reveal-delay-3 group">
                    ...
                    <h4 class="text-xl font-bold mb-3">Lifestyle Management</h4>
                    <p class="text-gray-300 font-light leading-relaxed">Sleep regulation, stress management, and routine optimization.</p>
                </div>
            </div>
        </div>
    </section>
