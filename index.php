    ...
    <main>
        ...
        <section class="relative h-[90vh] min-h-[600px] flex items-center justify-center overflow-hidden">
            ...
            <div class="absolute inset-0 z-0">
                <img src="assets/images/hero_bg.png" alt="Advanced Psychiatry Clinic Room" class="w-full h-full object-cover">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div class="bg-white rounded-2xl flex flex-col h-full border-[2px] border-primary p-6 shadow-sm hover:shadow-md transition-all duration-300 reveal">
                        ...
                        <img src="assets/images/service_tms.png" alt="Deep TMS Therapy" class="w-full h-48 object-cover rounded-xl mt-auto">
                    </div>
                    ...
                    <div class="bg-white rounded-2xl flex flex-col h-full border-[2px] border-primary p-6 shadow-sm hover:shadow-md transition-all duration-300 reveal reveal-delay-1">
                        ...
                        <img src="assets/images/service_vns.png" alt="VNS Therapy" class="w-full h-48 object-cover object-top rounded-xl mt-auto border border-gray-100">
                    </div>
                </div>
            </div>
        </section>
