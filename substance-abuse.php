        ...
        <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
            <div class="max-w-3xl reveal text-left">
                ...
                <h1 class="text-4xl md:text-5xl lg:text-7xl font-bold text-white tracking-tight leading-tight mb-6">
                    TMS for Substance Use <br/><span class="text-[#23bfe2] font-light">& Smoking Cessation</span>
                </h1>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="flex flex-col lg:flex-row items-center gap-16 lg:gap-20">
                ...
                <div class="w-full lg:w-1/2 relative reveal">
                    <div class="relative rounded-[2.5rem] overflow-hidden shadow-2xl border border-gray-100 ring-1 ring-[#0B2035]/5">
                        <img src="assets/images/tms_machine.png" alt="TMS for Smoking Cessation" class="w-full h-[500px] object-cover">
                        <div class="absolute inset-0 bg-gradient-to-tr from-[#0B2035]/20 via-transparent to-transparent"></div>
                    </div>
                    ...
                    <div class="absolute -bottom-6 -right-6 bg-white p-5 rounded-3xl border border-gray-100 shadow-[0_20px_40px_-10px_rgba(11,32,53,0.15)] flex items-center gap-4 group hover:-translate-y-2 transition-transform duration-500">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500 font-bold uppercase tracking-widest mt-1">Quit Rate with TMS</p>
                        </div>
                    </div>
                </div>
    ...
    <section class="py-16 bg-[#0B2035] relative overflow-hidden text-white border-t border-white/10">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div class="text-center mt-10 reveal">
                <p class="text-gray-400 font-light text-lg italic max-w-3xl mx-auto">TMS is not a stand-alone "magic cure," but when integrated with personalized care under physician direction, it can be a valuable component of a supportive strategy for those ready to make a change.</p>
            </div>
        </div>
    </section>

    <!-- How TMS Works for Substance Abuse -->
    <section class="py-16 bg-white relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="text-center max-w-3xl mx-auto mb-16 reveal">
                ...
                <h3 class="text-4xl md:text-5xl font-bold text-[#0B2035] mb-6">How TMS Works for Substance Abuse</h3>
                <p class="text-gray-600 text-lg leading-relaxed font-light">
                    Transcranial magnetic stimulation (TMS) targets specific areas of the brain involved in addiction and impulse control. By delivering magnetic pulses to these regions, TMS can help modulate neural activity, reducing cravings and improving self-control. This can make it easier to resist the urge to use substances and support long-term recovery.
                </p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="bg-neutral rounded-[2rem] p-10 shadow-soft border border-gray-100 hover:-translate-y-2 hover:shadow-2xl transition-all duration-300 reveal reveal-delay-1 group text-center">
                    ...
                    <p class="text-gray-500 font-light leading-relaxed">TMS is a non-invasive procedure that does not require medication, avoiding potential side effects of pharmaceuticals.</p>
                </div>
                ...
                <div class="bg-neutral rounded-[2rem] p-10 shadow-soft border border-gray-100 hover:-translate-y-2 hover:shadow-2xl transition-all duration-300 reveal reveal-delay-2 group text-center">
                    ...
                    <p class="text-gray-500 font-light leading-relaxed">By improving brain function and reducing cravings, TMS enhances the effectiveness of other addiction treatments and supports long-term recovery.</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="relative reveal group">
                    <div class="bg-white rounded-[2rem] p-10 border border-gray-100 hover:shadow-xl transition-all duration-300 h-full">
                        ...
                        <p class="text-gray-500 font-light leading-relaxed">
                            Your journey begins with a comprehensive evaluation. Our team assesses your medical history, current symptoms, and treatment goals to determine if TMS is the right choice for you.
                        </p>
                    </div>
                ...
                <div class="relative reveal reveal-delay-1 group">
                    <div class="bg-white rounded-[2rem] p-10 border border-gray-100 hover:shadow-xl transition-all duration-300 h-full">
                        ...
                        <p class="text-gray-500 font-light leading-relaxed">
                            TMS sessions typically last about 20-40 minutes and are conducted five days a week for several weeks. You'll sit comfortably while the device delivers magnetic pulses—no anesthesia needed, resume normal activities immediately.
                        </p>
                    </div>
                    <div class="hidden lg:block absolute top-1/2 -right-4 text-[#23bfe2]/30">
                        <i data-lucide="chevron-right" class="w-8 h-8"></i>
    ...
    <section class="py-16 bg-[#0B2035] text-white relative border-t-[8px] border-[#23bfe2]">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="space-y-4">
                ...
                <div class="bg-white/5 border border-white/10 rounded-2xl overflow-hidden reveal">
                    <button class="faq-toggle w-full px-8 py-6 text-left font-bold text-xl flex items-center justify-between focus:outline-none hover:bg-white/5 transition-colors group">
                        <span>Can TMS help with addiction?</span>
                        <div class="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-[#23bfe2] group-hover:bg-[#23bfe2] group-hover:text-[#0B2035] transition-colors">
                            <i data-lucide="plus" class="w-5 h-5 transition-transform duration-300"></i>
                        </div>
                    </button>
