<?php
$page_title       = 'Substance Use & Smoking Cessation Treatment in Newport Beach & San Juan Capistrano | Resiliency Mind + Body Medicine®';
$page_description = 'FDA-cleared Deep TMS for substance use disorders & smoking cessation in Newport Beach & San Juan Capistrano, CA. Comprehensive addiction recovery treatment.';
$page_keywords    = 'substance use treatment Newport Beach, addiction recovery San Juan Capistrano, smoking cessation TMS Orange County, addiction psychiatrist Newport Beach CA';
...
<main>
            ...
            <div class="flex flex-col lg:flex-row items-center gap-16 lg:gap-20">
                ...
                <div class="w-full lg:w-1/2 relative reveal">
                    <div class="relative rounded-[2.5rem] overflow-hidden shadow-2xl border border-gray-100 ring-1 ring-[#0B2035]/5">
                        <img src="assets/images/brainsway-image.webp" alt="Deep TMS for Smoking Cessation" class="w-full h-[500px] object-cover">
    ...
    <section class="py-16 relative overflow-hidden bg-white">
        <div class="absolute inset-0 z-0">
            <img src="assets/images/substance_abuse_hero.png" alt="Path to Recovery" class="w-full h-full object-cover opacity-10">
