...
<main>
    ...
    <section class="relative min-h-[500px] md:h-[60vh] flex items-center justify-center overflow-hidden pt-28 pb-12 md:pt-24 md:pb-0">
        ...
        <div class="absolute inset-0 z-0 bg-[#0B2035]">
            <img src="assets\images\breadcrumbs\accel-bread.webp" alt="Accelerated Deep TMS SWIFT Protocol" class="hidden lg:block w-full h-full object-cover object-[50%_20%]">
            <img src="assets\images\breadcrumbs\accelerated-tms-bread.webp" alt="Accelerated Deep TMS SWIFT Protocol" class="lg:hidden w-full h-full object-cover object-right md:object-[50%_30%]">
    ...
    <section class="py-12 bg-gray-50 border-t border-gray-100">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-wrap gap-3">
                <a href="tms-therapy.php" class="inline-flex items-center gap-2 px-5 py-2.5 rounded-full border border-[#0B2035]/15 text-[#0B2035] text-sm font-medium hover:bg-[#0B2035] hover:text-white transition-all">Standard Deep TMS Therapy</a>
