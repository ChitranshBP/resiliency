            ...
            <div class="flex flex-col lg:flex-row items-center gap-16 lg:gap-20">
                    ...
                    <div class="bg-neutral p-6 rounded-2xl mb-8 border border-gray-100">
                        <ul class="space-y-4">
                            ...
                            <li class="flex items-center gap-4">
                                ...
                                <span class="text-[#0B2035] font-semibold text-base">70% fewer clinic visits than standard protocol</span>
                            </li>
                            <li class="flex items-center gap-4">
                                <div class="bg-[#23bfe2]/20 p-2 rounded-lg text-[#23bfe2]">
                                    <i data-lucide="check" class="w-5 h-5"></i>
                                </div>
                                <span class="text-[#0B2035] font-semibold text-base">FDA-cleared Deep TMS technology</span>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="w-full lg:w-1/2 relative reveal reveal-delay-1">
                    ...
                    <div class="absolute -bottom-8 -left-8 bg-white p-6 rounded-3xl border border-gray-100 shadow-[0_20px_40px_-10px_rgba(11,32,53,0.15)] flex items-center gap-5 group hover:-translate-y-2 transition-transform duration-500">
                        ...
                        <div>
                            <p class="text-4xl font-bold text-[#0B2035] tracking-tight">87.8<span class="text-[#23bfe2]">%</span></p>
    ...
    <section class="py-16 bg-[#0B2035] relative overflow-hidden text-white border-t border-white/10">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="text-center max-w-3xl mx-auto mb-16 reveal">
                ...
                <h3 class="text-4xl md:text-5xl font-bold mb-6">Landmark Clinical Results</h3>
            </div>

            <!-- Stats Cards -->
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
                <!-- Stat 1 -->
                <div class="bg-white/5 border border-white/10 rounded-[2rem] p-10 text-center hover:-translate-y-2 hover:shadow-2xl transition-all duration-300 reveal group">
                    ...
                    <p class="text-5xl font-bold text-[#23bfe2] mb-4">87.8%</p>
                    <p class="text-gray-300 font-light leading-relaxed">Response rate on the Hamilton Depression Rating Scale</p>
                </div>

                <!-- Stat 2 -->
                <div class="bg-white/5 border border-white/10 rounded-[2rem] p-10 text-center hover:-translate-y-2 hover:shadow-2xl transition-all duration-300 reveal reveal-delay-1 group">
                    <div class="w-16 h-16 bg-[#23bfe2]/10 rounded-2xl flex items-center justify-center text-[#23bfe2] mb-6 mx-auto group-hover:bg-[#23bfe2] group-hover:text-[#0B2035] transition-colors">
                        <i data-lucide="heart-pulse" class="w-8 h-8"></i>
                    </div>
                    <p class="text-5xl font-bold text-[#23bfe2] mb-4">78%</p>
                    <p class="text-gray-300 font-light leading-relaxed">Remission rate on the Hamilton Depression Rating Scale</p>
                </div>

                <!-- Stat 3 -->
                <div class="bg-white/5 border border-white/10 rounded-[2rem] p-10 text-center hover:-translate-y-2 hover:shadow-2xl transition-all duration-300 reveal reveal-delay-2 group">
                    <div class="w-16 h-16 bg-[#23bfe2]/10 rounded-2xl flex items-center justify-center text-[#23bfe2] mb-6 mx-auto group-hover:bg-[#23bfe2] group-hover:text-[#0B2035] transition-colors">
                        <i data-lucide="shield-check" class="w-8 h-8"></i>
                    </div>
                    <p class="text-5xl font-bold text-[#23bfe2] mb-4">82%</p>
                    <p class="text-gray-300 font-light leading-relaxed">Of patients completing 30+ sessions achieve relief from depression</p>
                </div>
            </div>

            <!-- Additional Text -->
            <div class="max-w-4xl mx-auto reveal">
                <div class="space-y-6 text-gray-300 font-light leading-relaxed text-lg text-center">
                    <p>
                        Quality-of-life scores improved by approximately 32 percentage points from baseline. Proportion of patients reporting severe functional impairment declined from 85-100% at baseline to 15-17% at end of treatment.
                    </p>
                </div>
            </div>
        </div>
    ...
    <section class="py-16 bg-neutral relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center max-w-3xl mx-auto mb-20 reveal">
                <h2 class="text-sm font-bold tracking-widest text-[#23bfe2] uppercase mb-4">Is It Right For You</h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="bg-white rounded-[2rem] p-10 shadow-soft border border-gray-100 hover:-translate-y-2 hover:shadow-2xl transition-all duration-300 reveal group">
                    ...
                    <h4 class="text-2xl font-bold text-primary mb-4">Diagnosed Conditions</h4>
                    <p class="text-gray-500 font-light leading-relaxed">Individuals diagnosed with depression, anxiety, or other mental health disorders seeking rapid relief.</p>
                </div>
                ...
                <div class="bg-white rounded-[2rem] p-10 shadow-soft border border-gray-100 hover:-translate-y-2 hover:shadow-2xl transition-all duration-300 reveal reveal-delay-1 group">
                    ...
                    <h4 class="text-2xl font-bold text-primary mb-4">Treatment-Resistant</h4>
                    <p class="text-gray-500 font-light leading-relaxed">Patients who have not responded adequately to traditional treatments such as medication or therapy.</p>
                </div>
                ...
                <div class="bg-white rounded-[2rem] p-10 shadow-soft border border-gray-100 hover:-translate-y-2 hover:shadow-2xl transition-all duration-300 reveal reveal-delay-2 group">
                    ...
                    <h4 class="text-2xl font-bold text-primary mb-4">Non-Invasive Preference</h4>
                    <p class="text-gray-500 font-light leading-relaxed">Those seeking a non-invasive, drug-free alternative to improve their mental health quickly.</p>
                </div>
                ...
                <div class="bg-white rounded-[2rem] p-10 shadow-soft border border-gray-100 hover:-translate-y-2 hover:shadow-2xl transition-all duration-300 reveal group">
                    ...
                    <h4 class="text-2xl font-bold text-primary mb-4">Busy Schedules</h4>
                    <p class="text-gray-500 font-light leading-relaxed">Professionals and individuals who cannot commit to the standard 6-week daily treatment schedule.</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
                ...
                <div class="w-full lg:w-1/2 reveal">
                    ...
                    <h3 class="text-3xl md:text-4xl lg:text-5xl font-bold text-[#0B2035] mb-8 leading-tight">
                        BrainsWay <span class="text-[#23bfe2]">Ultra Provider</span> Status
                    </h3>
                        ...
                        <div class="relative rounded-[3rem] overflow-hidden shadow-2xl border-4 border-white ring-1 ring-gray-100">
                            ...
                            <div class="absolute bottom-10 -left-6 bg-[#0B2035] text-white p-6 rounded-3xl shadow-2xl border border-white/10 group-hover:-translate-y-2 transition-transform duration-500">
                                <div class="flex items-center gap-4">
                                    ...
                                    <div>
                                        <p class="font-bold text-lg leading-tight">Ultra Provider</p>
                                        <p class="text-[#23bfe2] text-xs font-bold uppercase tracking-widest mt-1">BrainsWay Certified</p>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <section class="py-16 bg-[#0B2035] text-white relative border-t-[8px] border-[#23bfe2]">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="space-y-4">
                ...
                <div class="bg-white/5 border border-white/10 rounded-2xl overflow-hidden reveal">
                    <button class="faq-toggle w-full px-8 py-6 text-left font-bold text-xl flex items-center justify-between focus:outline-none hover:bg-white/5 transition-colors group">
                        <span>What side effects can I expect?</span>
                        <div class="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-[#23bfe2] group-hover:bg-[#23bfe2] group-hover:text-[#0B2035] transition-colors">
                            <i data-lucide="plus" class="w-5 h-5 transition-transform duration-300"></i>
                        </div>
                    </button>
                    <div class="faq-content px-8 pb-8 text-gray-300 font-light leading-relaxed text-lg hidden">
                        <div class="pt-2 border-t border-white/10 mt-2">
                            Side effects are similar to standard TMS—mild scalp discomfort or headache during initial sessions that typically resolve quickly. No sedation is required, and you can drive yourself to and from appointments.
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="columns-1 md:columns-2 lg:columns-3 gap-6 space-y-6">
                ...
                <div class="break-inside-avoid bg-white border border-gray-100 p-8 rounded-[2rem] shadow-sm hover:shadow-xl transition-all duration-300 group">
                    ...
                    <p class="text-gray-700 text-base leading-relaxed mb-8 font-light italic">
                        "The accelerated protocol fit perfectly into my schedule. Five days and I felt like a completely different person. The team at Resiliency made it seamless."
                    </p>
                    <div class="flex items-center justify-between border-t border-gray-50 pt-6">
                        <div class="flex items-center gap-3">
                            <div class="w-10 h-10 rounded-full bg-pink-100 text-[#0B2035] flex items-center justify-center font-bold text-sm">AW</div>
                            <span class="font-bold text-gray-800">Alex W.</span>
                        </div>
                ...
                <div class="break-inside-avoid bg-white border border-gray-100 p-8 rounded-[2rem] shadow-sm hover:shadow-xl transition-all duration-300 group">
                    ...
                    <p class="text-gray-700 text-base leading-relaxed mb-8 font-light italic">
                        "I had tried medications for years with minimal improvement. The SWIFT protocol gave me more relief in one week than I'd experienced in a decade of traditional treatment."
                    </p>
                    <div class="flex items-center justify-between border-t border-gray-50 pt-6">
                        <div class="flex items-center gap-3">
                            <div class="w-10 h-10 rounded-full bg-[#23bfe2]/10 text-[#23bfe2] flex items-center justify-center font-bold text-sm">PD</div>
                            <span class="font-bold text-gray-800">Patricia D.</span>
                        </div>
                        <div class="flex items-center gap-2 text-xs text-gray-400">
                            <img src="https://upload.wikimedia.org/wikipedia/commons/2/2f/Google_2015_logo.svg" alt="Google" class="h-3">
                            Google Review
                ...
                <div class="break-inside-avoid bg-white border border-gray-100 p-8 rounded-[2rem] shadow-sm hover:shadow-xl transition-all duration-300 group">
                    ...
                    <div class="flex items-center justify-between border-t border-gray-50 pt-6">
                        <div class="flex items-center gap-3">
                            <div class="w-10 h-10 rounded-full bg-indigo-100 text-[#0B2035] flex items-center justify-center font-bold text-sm">JH</div>
                            <span class="font-bold text-gray-800">James H.</span>
                        </div>
                        <div class="flex items-center gap-2 text-xs text-gray-400">
                            <img src="https://upload.wikimedia.org/wikipedia/commons/2/2f/Google_2015_logo.svg" alt="Google" class="h-3">
                            Google Review
