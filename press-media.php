        ...
        <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
            <div class="max-w-3xl reveal text-left">
                <div class="flex items-center gap-3 mb-6">
                    ...
                    <span class="text-[#23bfe2] text-sm font-bold tracking-widest uppercase">In The News</span>
                </div>
                <h1 class="text-4xl md:text-5xl lg:text-7xl font-bold text-white tracking-tight leading-tight mb-6">
                    Press & <br/><span class="text-[#23bfe2] font-light">Media</span>
                </h1>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 reveal">
                ...
                <div class="bg-white border border-gray-100 rounded-[2rem] p-8 hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                    <div class="flex items-center gap-3 mb-4">
                        ...
                        <span class="text-sm text-gray-400 font-light">Press Feature</span>
                    </div>
                    <h3 class="text-xl font-bold text-[#0B2035] mb-3">BrainsWay Ultra Provider Recognition</h3>
                    <p class="text-gray-600 font-light leading-relaxed mb-6">
                        Resiliency Mind + Body Medicine recognized as a BrainsWay Ultra Provider&mdash;the highest tier designation for Deep TMS treatment volume and clinical excellence.
                    </p>
                    <div class="flex items-center gap-2 text-[#23bfe2] font-bold text-sm">
                        <i data-lucide="calendar" class="w-4 h-4"></i>
                        <span class="text-gray-400 font-light">Coming Soon</span>
                    </div>
                </div>
                ...
                <div class="bg-white border border-gray-100 rounded-[2rem] p-8 hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                    ...
                    <h3 class="text-xl font-bold text-[#0B2035] mb-3">Advancing TMS Therapy in Orange County</h3>
                    <p class="text-gray-600 font-light leading-relaxed mb-6">
                        Dr. Stefani LaFrenierre brings cutting-edge interventional psychiatry to Newport Beach with Deep TMS, SPRAVATO, and integrative mental health services.
                    </p>
                    <div class="flex items-center gap-2 text-[#23bfe2] font-bold text-sm">
                        <i data-lucide="calendar" class="w-4 h-4"></i>
                        <span class="text-gray-400 font-light">Coming Soon</span>
                ...
                <div class="bg-white border border-gray-100 rounded-[2rem] p-8 hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                    ...
                    <h3 class="text-xl font-bold text-[#0B2035] mb-3">The Rise of Integrative Psychiatry</h3>
                    <p class="text-gray-600 font-light leading-relaxed mb-6">
                        How Resiliency Mind + Body Medicine is redefining psychiatric care by combining advanced neuromodulation with functional medicine and lifestyle interventions.
                    </p>
                    <div class="flex items-center gap-2 text-[#23bfe2] font-bold text-sm">
                        <i data-lucide="calendar" class="w-4 h-4"></i>
                        <span class="text-gray-400 font-light">Coming Soon</span>
